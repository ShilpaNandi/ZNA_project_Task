...
public partial class Invoice_InvoicingMailingDtls : AISBasePage
{
    ...
    private AISTransactionWrapper IMDTransaction
    {
        get
        {
            ...
            if (RetrieveObjectFromSessionUsingWindowName("IMDTransaction") == null)
                SaveObjectToSessionUsingWindowName("IMDTransaction", new AISTransactionWrapper());
            return (AISTransactionWrapper)RetrieveObjectFromSessionUsingWindowName("IMDTransaction");
        }
        set
        {
            //Session["IMDTransaction"] = value;
            SaveObjectToSessionUsingWindowName("IMDTransaction", value);
        }
    }
    #endregion
    ...
    public void BindData()
    {
        ...
        if (invmailingBEList.Count > 0)
        {
            //phase -3
            int count = 0;
            count = invmailingBEList.Count;
            int prem_adj_id = 0;
            for (int i = 0; i < count; i++)
            {
                prem_adj_id = invmailingBEList[i].PREM_ADJ_ID;
                ...
                if (dtProgrSummZDWKey != null)
                {
                    if (dtProgrSummZDWKey.Rows.Count > 0)
                    {
                        ...
                        if (invmailingBEList[i].FINAL_INV_TXT==string.Empty)
                        {
                          invmailingBEList[i].DRFT_PS_WRKSHT_PDF_ZDW_KEY_TXT = dtProgrSummZDWKey.Rows[0].Field<string>("drft_Progsumm_spreadsheet_zdw_key_txt");
                        }
                        else
                        {
                          invmailingBEList[i].DRFT_PS_WRKSHT_PDF_ZDW_KEY_TXT = dtProgrSummZDWKey.Rows[0].Field<string>("fnl_Progsumm_spreadsheet_zdw_key_txt");
                        }
    ...
    protected void lsvInvoiceMailing__SelectedIndexChanging(object sender, ListViewSelectEventArgs e)
    {
        ...
        //Session["ID"] = intID;
        SaveObjectToSessionUsingWindowName("ID", intID);
    ...
    private InvoiceMailingDtlsBE invmailingBE
    {
        ...
        get { return (InvoiceMailingDtlsBE)RetrieveObjectFromSessionUsingWindowName("invmailingBE"); }
        set { SaveObjectToSessionUsingWindowName("invmailingBE", value); }
    }
    private IList<InvoiceMailingDtlsBE> invmailingBEList
    {
        ...
        get { return (IList<InvoiceMailingDtlsBE>)RetrieveObjectFromSessionUsingWindowName("invmailingBEList"); }
        set { SaveObjectToSessionUsingWindowName("invmailingBEList", value); }
    }
    ...
    public void DisplayDetails(int intID)
    {
        ...
        //Session["AdjID"] = intID;
        SaveObjectToSessionUsingWindowName("AdjID", intID);
        ...
        SaveObjectToSessionUsingWindowName("PrmAdjStsID", invmailingBE.ADJ_STS_ID);
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        InvoiceMailingDtlsBE IMBE = invmailingBS.getInvoiceMailingDtlsRow(Convert.ToInt32(RetrieveObjectFromSessionUsingWindowName("AdjID").ToString()));
        //Concurrency Issue
        if (ViewState["Value"] != null)
        {
            //InvoiceMailingDtlsBE IMBEold = (invmailingBEList.Where(o => o.PREM_ADJ_ID.Equals(Convert.ToInt32(Session["AdjID"].ToString())))).First();
            InvoiceMailingDtlsBE IMBEold = (invmailingBEList.Where(o => o.PREM_ADJ_ID.Equals(Convert.ToInt32(RetrieveObjectFromSessionUsingWindowName("AdjID").ToString())))).First();
        ...
        if (ViewState["Value"] != null)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    PremiumAdjustmentStatusBE prmadjstsBEold = prmadjstsBS.getPreAdjStatusRow(Convert.ToInt32(RetrieveObjectFromSessionUsingWindowName("PrmAdjStsID").ToString()));
        ...
        if (lsvInvoiceMailing.Items.Count > 0)
        {
            ...
            for (int i = 0; i < lsvInvoiceMailing.Items.Count; i++)
            {
                ...
                if (Convert.ToInt32(lnkSelect.CommandArgument) == Convert.ToInt32(RetrieveObjectFromSessionUsingWindowName("AdjID").ToString()))
                {
                    selectedindex = i;
                    break;
                }
        ...
        DisplayDetails(Convert.ToInt32(RetrieveObjectFromSessionUsingWindowName("AdjID").ToString()));
        //if (transaction == true)
        //{
    ...
    protected void btnFinal_Click(object sender, EventArgs e)
    {
        ...
        objInvBE = objInvBS.getPremiumAdjustmentRow(Convert.ToInt32(RetrieveObjectFromSessionUsingWindowName("AdjID").ToString()));
        bool HistFlag = false;
        ...
        {
            //strMessage = objID.generateFinalInvoiceWithTOC(Convert.ToInt32(Session["AdjID"].ToString()), txtComments.Text.Trim(), HistFlag);
            strMessage = objID.generateFinalInvoiceWithTOC(Convert.ToInt32(RetrieveObjectFromSessionUsingWindowName("AdjID").ToString()), txtComments.Text.Trim(), HistFlag);
        }
        else
        {
            ...
            {
                //strMessage = objID.generateRevisedFinalInvoiceWithTOC(Convert.ToInt32(Session["AdjID"].ToString()), objInvPreviousBE.PREMIUM_ADJ_ID, txtComments.Text.Trim(), HistFlag);
                strMessage = objID.generateRevisedFinalInvoiceWithTOC(Convert.ToInt32(RetrieveObjectFromSessionUsingWindowName("AdjID").ToString()), objInvPreviousBE.PREMIUM_ADJ_ID, txtComments.Text.Trim(), HistFlag);
            }
            else
            {
