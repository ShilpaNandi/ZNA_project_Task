...
public partial class AppMgmt_InvoiceExhibit : AISBasePage
{
    ...
    private IList<InvoiceExhibitBE> invoiceExhibitBEList
    {
        ...
        get { return (IList<InvoiceExhibitBE>)RetrieveObjectFromSessionUsingWindowName("InvoiceExhibitBE"); }
        set { SaveObjectToSessionUsingWindowName("InvoiceExhibitBE", value); }
    }
    #endregion
