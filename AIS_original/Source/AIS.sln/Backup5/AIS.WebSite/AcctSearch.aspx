            ...
            <table>
                <tr>
                    ...
                    <td style="width: 168px">
                        <asp:TextBox ID="txtInsuredName" runat="server" OnTextChanged="txtInsuredName_TextChanged"
                ...
                <tr>
                    ...
                    FilterType="Numbers,LowerCaseLetters,UpperCaseLetters"
                        ...
                        <asp:TextBox ID="txtBPNumber" runat="server" Width="210px"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td style="width: 168px">
                        ...
                        <asp:TextBox ID="txtAccountNumber" runat="server" Width="210px"></asp:TextBox>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td style="width: 168px;">
                        <asp:TextBox ID="txtSSCGID" runat="server" Width="210px"></asp:TextBox>
                 ...
                 <tr>
                    ...
                    <td style="width: 168px; height: 42px;">
                        <asp:TextBox ID="txtPolicyNo" runat="server" Width="210px"></asp:TextBox>
