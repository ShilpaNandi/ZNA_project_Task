...
namespace ZurichNA.AIS.WebSite.Reports {
    ...
    public class srptRemittance : ReportClass {
        
        public srptRemittance() {
        }
        
        public override string ResourceName {
            get {
                return "srptRemittance.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "ZurichNA.AIS.WebSite.Reports.srptRemittance.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedsrptRemittance : Component, ICachedReport {
        
        public CachedsrptRemittance() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            srptRemittance rpt = new srptRemittance();
            rpt.Site = this.Site;
            return rpt;
        }
