  ...
  <Length PropertyKey="height" StartValueScript=
	"$find('AutoCompleteEx')._height" EndValue="0" />
                                ...
                                <tr>
                                   ...
                                   <%-- </td>
                                    <td>--%>
                                        ...
                                        <asp:Button ForeColor="White" BackColor="#9494C8" EnableTheming="false" ID="btnErrorLogCountZeroAccountAssignment"
                                            runat="server" Text="Error Log" OnClick="btnErrorLogCountZeroAccountAssignment_Click" Visible="false" />
                                   <%-- </td>
                                    <td>--%>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="center" colspan="2">
                                        ...
                                        <asp:Button ForeColor="White" BackColor="#9494C8" ID="btnClose" runat="server" Text="Close"
                                           ...
                                           <asp:Button ForeColor="White" BackColor="#9494C8" ID="btnErrorLog" runat="server" Text="Error Log"
                                            OnClick="btnErrorLog_Click" Visible="false" />
                                        <br />
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <td align="right">
                                            <asp:UpdatePanel ID="upExcel" runat="server">
                                                <ContentTemplate>
                                                    ...
                                                    <asp:Button runat="server" ID="btnErrorAccountAssignment" Text="Error Log" Visible="false"
                                                        OnClick="btnErrorAccountAssignment_Click" />
                                                </ContentTemplate>
                                                <Triggers>
                                                    <asp:PostBackTrigger ControlID="btnExport" />
                                                    <asp:PostBackTrigger ControlID="btnErrorAccountAssignment" />
                                                </Triggers>
                                            </asp:UpdatePanel>
                                        </td>
                                    </tr>
        ...
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="btnErrorLogCountZeroAccountAssignment" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
