                    ...
                    <td>
                        <ajaxToolkit:TabContainer ID="TabConDashboard" runat="server" CssClass="VariableTabs"
                            ...
                            <ajaxToolkit:TabPanel runat="server" ID="tplPpInfo">
                                ...
                                <ContentTemplate>
                                    <asp:Panel ID="panPpInfo" runat="server" Height="290px" Width="910px" ScrollBars="Auto"
                                        Visible="true">
                                            ...
                                            <ItemTemplate>
                                                <tr id="Tr1" runat="server" class="ItemTemplate">
                                                    <td align="left">
                                                        ...
                                                        <asp:Label ID="lblActName" Width="145px" runat="server" Text='<%# Bind("CUSTMR_NAME")%>'></asp:Label>
                                                    </td>
                                                    <td align="left" style="width: 65px">
                                                        <asp:Label ID="lblPrgmPrd" Width="65px" runat="server" Text='<%# Bind("PROGRAMPERIOD")%>'></asp:Label>
                                                    </td>
                                                    <td style="width: 50px">
                                                        <asp:Label ID="lblprgmType" Width="50px" runat="server" Text='<%# Bind("PROGRAMTYPENAME")%>'></asp:Label>
                                                    </td>
                                                    <td align="left" style="width: 63px">
                                                        <asp:Label ID="lblFirstAdjDt" Width="63px" runat="server" Text='<%# Eval("FST_ADJ_DT", "{0:d}")%>'></asp:Label>
                                                    </td>
                                                    <td align="left" style="width: 63px">
                                                        <asp:Label ID="lblFinalAdjDt" Width="63px" runat="server" Text='<%# Eval("NXT_VALN_DT", "{0:d}")%>'></asp:Label>
                                                    </td>
                                                    <td align="left" style="width: 154px">
                                                        <asp:Label ID="lblBuOffice" Width="154px" runat="server" Text='<%# Bind("BUSINESSUNITNAME")%>'></asp:Label>
                                                    </td>
                                                    <td style="width: 50px">
                            ...
                            <ajaxToolkit:TabPanel runat="server" ID="tplAdjustmentInfo">
                                ...
                                <ContentTemplate>
                                    <asp:Panel ID="Panel1" runat="server" Height="290px" Width="910px" ScrollBars="Auto"
                                        Visible="true">
                            ...
                            <ajaxToolkit:TabPanel runat="server" ID="tpInvoiceDetails">
                                ...
                                <ContentTemplate>
                                    <asp:Panel ID="Panel2" runat="server" Height="290px" Width="910px" ScrollBars="Auto"
                                        Visible="true">
                                        <asp:AISListView OnItemDataBound="lstInv_DataBoundList" ID="lstInv" runat="server"
                                            ...
                                            <ItemTemplate>
                                                <tr id="Tr1" runat="server" class="ItemTemplate">
                                                    <td>
                                                        <asp:Label ID="lblActNum" Width="30px" runat="server" Text='<%# Bind("ACCOUNTID")%>'></asp:Label>
                                                    </td>
                                                    <td align="left">
                                                        <asp:Label ID="lblActName" Width="90px" runat="server" Text='<%# Bind("CUSTMR_NAME")%>'></asp:Label>
                                                    </td>
                                                    <td align="left">
                                                        <asp:Label ID="lblValDate" Width="45px" runat="server" Text='<%# Eval("VALN_DT", "{0:d}")%>'></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="lblAdjNum" runat="server" width="45px" Text='<%# Bind("PREMIUM_ADJ_ID")%>'></asp:Label>
                                                    </td>
                                                    <td align="left">
                                                        <asp:Label ID="lblInvNum" Width="55px" runat="server" Text='<%#Bind("INVC_NBR_TXT") %>'></asp:Label>
                                                    </td>
                                                    <td align="left">
                                                        <asp:Label ID="lblInvDt" Width="53px" runat="server" Text='<%# Eval("INVC_DUE_DT", "{0:d}")%>'></asp:Label>
                                                    </td>
                                                    <td align="left">
                                                        <asp:Label ID="lblInvoiceAmt" Width="60px" runat="server" Text='<%# Eval("INVC_AMT") != null ? (Eval("INVC_AMT").ToString() != "" ?(decimal.Parse(Eval("INVC_AMT").ToString())).ToString("#,##0") : "0"): "0"%>'></asp:Label>
                                                    </td>
                                                    <td style="width: 50px">
                                                    ...
                                                    <td >
                                                        <asp:Label ID="lblHdPremAdjPgmId" runat="server" Text='<%# Bind("PREM_ADJ_PGM_ID") %>'
                                                            Visible="false"></asp:Label>
                                                        <asp:LinkButton ID="lbnViewLossInfo" Width="55px" runat="server" Text="Loss Info"
                                                            CommandName="LossInfo" CommandArgument='<%# Eval("ACCOUNTID")%> '></asp:LinkButton>
                                                    </td>
                                                    <td style="width: 110px">
                                                        ...
                                                        <br />
                                                        <asp:LinkButton ID="lnkDraftCDWorksheet" style="text-align:left" runat="server" Text="Worksheet PDF" Enabled='<%#(Eval("DRFT_CD_WRKSHT_PDF_ZDW_KEY_TXT")!=null?(Eval("DRFT_CD_WRKSHT_PDF_ZDW_KEY_TXT").ToString()!=""? true:false):false)%>'
                                            ...
                                            <AlternatingItemTemplate>
                                                <tr id="Tr1" runat="server" class="AlternatingItemTemplate">
                                                    ...
                                                    <td align="left">
                                                        <asp:Label ID="lblInvNum" Width="60px" runat="server" Text='<%#Bind("INVC_NBR_TXT") %>'></asp:Label>
                                                    </td>
                                                    <td align="left">
                                                        <asp:Label ID="lblInvDt" Width="53px" runat="server" Text='<%# Eval("INVC_DUE_DT", "{0:d}")%>'></asp:Label>
                                                    </td>
