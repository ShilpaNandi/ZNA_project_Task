...
public partial class Invoice_InvoiceInquiry : AISBasePage
{
    ...
    private DataTable dtInvoiceInquiry
    {
        ...
        get { return (DataTable)RetrieveObjectFromSessionUsingWindowName("InvoiceInquiry"); }
        set { SaveObjectToSessionUsingWindowName("InvoiceInquiry", value); }
    }
    #endregion
    ...
    private void ChangeDetailState(bool Flag)
    {
        ...
        pnlInvInqist.Height = (Flag == true ? Unit.Point(60) : Unit.Point(180));
    }
    #endregion
    ...
    private void Export2Excel()
    {
        ...
        string strFileName = "Invoice Inquiry Report" + "_" + CurrentAISUser.PersonID + "_" + strDate + sSpreadsheetGearExcelFileFormat;
        ...
        //cell2[1].Text = HttpUtility.HtmlEncode(Convert.ToString(this.AccountName));
        //AddStyle(cell2, true);
        ...
        //cell3[1].Text = HttpUtility.HtmlEncode(Convert.ToString(this.ProgramType));
        //AddStyle(cell3, true);
        ...
        //cell4[1].Text = HttpUtility.HtmlEncode(Convert.ToString(this.ValuationDate));
        //AddStyle(cell4, true);
        ...
        //cell5[1].Text = HttpUtility.HtmlEncode(Convert.ToString(this.InvoiceNumber));
        //AddStyle(cell5, true);
        ...
        //cell6[1].Text = HttpUtility.HtmlEncode(Convert.ToString(this.InvoiceDate));
        //AddStyle(cell6, true);
        ...
        //cell7[1].Text = HttpUtility.HtmlEncode(Convert.ToString(this.CFS2Name));
        //AddStyle(cell7, true);
        ...
        //cell8[1].Text = HttpUtility.HtmlEncode(Convert.ToString(this.BrokerName));
        //AddStyle(cell8, true);
        ...
        //cell9[1].Text = HttpUtility.HtmlEncode(Convert.ToString(this.BusinessUnit));
        //AddStyle(cell9, true);
        ...
        dt.Columns.Add("INSURED CONTACT");
        dt.Columns.Add("VALUATION DATE");
        dt.Columns.Add("BROKER");
        dt.Columns.Add("BROKER CONTACT");
        dt.Columns.Add("BU OFFICE");
        dt.Columns.Add("INVOICE NUMBER");
        dt.Columns.Add("INVOICE DATE");
        dt.Columns.Add("INVOICE AMOUNT");
        dt.Columns.Add("ADJ. STATUS");
        dt.Columns.Add("ADJ. STATUS DATE");
        dt.Columns.Add("DRAFT INVOICE DATE");
        dt.Columns.Add("FINAL INVOICE DATE");
        ...
        for (int row = 0; row < dtInvoicelist.Rows.Count; row++)
        {
            ...
            dt.Rows[i][0] = (dtInvoicelist.Rows[row]["ACCOUNT_NUMBER"] != null ? dtInvoicelist.Rows[row]["ACCOUNT_NUMBER"].ToString() : "");
            dt.Rows[i][1] = (dtInvoicelist.Rows[row]["ACCOUNT_NAME"] != null ? dtInvoicelist.Rows[row]["ACCOUNT_NAME"].ToString() : "");
            dt.Rows[i][2] = (dtInvoicelist.Rows[row]["INSURED_CONTACT"] != null ? dtInvoicelist.Rows[row]["INSURED_CONTACT"].ToString() : "");
            dt.Rows[i][3] = (dtInvoicelist.Rows[row]["VALUATION_DATE"] != null ? dtInvoicelist.Rows[row]["VALUATION_DATE"].ToString() : "");
            dt.Rows[i][4] = (dtInvoicelist.Rows[row]["BROKER"] != null ? dtInvoicelist.Rows[row]["BROKER"].ToString() : "");
            dt.Rows[i][5] = (dtInvoicelist.Rows[row]["BROKER_CONTACT"] != null ? dtInvoicelist.Rows[row]["BROKER_CONTACT"].ToString() : "");
            dt.Rows[i][6] = (dtInvoicelist.Rows[row]["BU_OFFICE"] != null ? dtInvoicelist.Rows[row]["BU_OFFICE"].ToString() : "");
            dt.Rows[i][7] = (dtInvoicelist.Rows[row]["DRFT_INVOICE_NUMBER"] != null ? dtInvoicelist.Rows[row]["DRFT_INVOICE_NUMBER"].ToString() : "");
            dt.Rows[i][8] = (dtInvoicelist.Rows[row]["INVOICE_DATE"] != null ? dtInvoicelist.Rows[row]["INVOICE_DATE"].ToString() : "");
            dt.Rows[i][9] = (dtInvoicelist.Rows[row]["INVOICE_AMOUNT"] != null ? dtInvoicelist.Rows[row]["INVOICE_AMOUNT"].ToString() : "");
            dt.Rows[i][10] = (dtInvoicelist.Rows[row]["ADJUSTMENT_STATUS"] != null ? dtInvoicelist.Rows[row]["ADJUSTMENT_STATUS"].ToString() : "");
            dt.Rows[i][11] = (dtInvoicelist.Rows[row]["ADJUSTMENT_STATUS_DATE"] != null ? dtInvoicelist.Rows[row]["ADJUSTMENT_STATUS_DATE"].ToString() : "");
            dt.Rows[i][12] = (dtInvoicelist.Rows[row]["DRAFT_INVOICE_DATE"] != null ? dtInvoicelist.Rows[row]["DRAFT_INVOICE_DATE"].ToString() : "");
            dt.Rows[i][13] = (dtInvoicelist.Rows[row]["FINAL_INVOICE_DATE"] != null ? dtInvoicelist.Rows[row]["FINAL_INVOICE_DATE"].ToString() : "");
        ...
        string strFilePath = ConfigurationManager.AppSettings["InvoiceInquiry_Excel_Export"] + "\\" + strFileName;
        string SheetName = "Invoice Inquiry Report";
    ...
    private void ExportToExcelusingSpreadsheetGear(DataTable Tbl, string ExcelFilePath, string strFileName, string SheetName)
    {
        try
        {
            ...
            if (Tbl.Columns.Count > 0)
            {
                ...
                sheetIndex++;
                // column headings
                SSG.IWorksheet worksheetViewInvoiceInquiry = workbook.Worksheets["Sheet" + sheetIndex.ToString()];
                worksheetViewInvoiceInquiry.Name = SheetName;

                // Get the worksheet cells reference. 
                SSG.IRange cellsviewInvoiceInquiry = worksheetViewInvoiceInquiry.Cells;
                cellIndex = 1;

                cellsviewInvoiceInquiry["A" + cellIndex.ToString()].Value = "PARAMETER";
                FormatHeaderTypeCellView(cellsviewInvoiceInquiry["A" + cellIndex.ToString()]);
                cellsviewInvoiceInquiry["B" + cellIndex.ToString()].Value = "VALUE";
                FormatHeaderTypeCellView(cellsviewInvoiceInquiry["B" + cellIndex.ToString()]);
                cellIndex = cellIndex + 1;
                cellsviewInvoiceInquiry["A" + cellIndex.ToString()].Value = "ACCOUNT NAME";
                FormatHeaderTypeCellView(cellsviewInvoiceInquiry["A" + cellIndex.ToString()]);
                cellsviewInvoiceInquiry["B" + cellIndex.ToString()].Value = HttpUtility.HtmlEncode(Convert.ToString(this.AccountName));
                FormatTypeCellView(cellsviewInvoiceInquiry["B" + cellIndex.ToString()]);
                cellIndex = cellIndex + 1;
                cellsviewInvoiceInquiry["A" + cellIndex.ToString()].Value = "PROGRAM TYPE";
                FormatHeaderTypeCellView(cellsviewInvoiceInquiry["A" + cellIndex.ToString()]);
                cellsviewInvoiceInquiry["B" + cellIndex.ToString()].Value = HttpUtility.HtmlEncode(Convert.ToString(this.ProgramType));
                FormatTypeCellView(cellsviewInvoiceInquiry["B" + cellIndex.ToString()]);
                cellIndex = cellIndex + 1;
                cellsviewInvoiceInquiry["A" + cellIndex.ToString()].Value = "VALUATION DATE";
                FormatHeaderTypeCellView(cellsviewInvoiceInquiry["A" + cellIndex.ToString()]);
                cellsviewInvoiceInquiry["B" + cellIndex.ToString()].Value = HttpUtility.HtmlEncode(Convert.ToString(this.ValuationDate));
                FormatTypeCellView(cellsviewInvoiceInquiry["B" + cellIndex.ToString()]);
                cellIndex = cellIndex + 1;
                cellsviewInvoiceInquiry["A" + cellIndex.ToString()].Value = "INVOICE NUMBER";
                FormatHeaderTypeCellView(cellsviewInvoiceInquiry["A" + cellIndex.ToString()]);
                cellsviewInvoiceInquiry["B" + cellIndex.ToString()].Value = HttpUtility.HtmlEncode(Convert.ToString(this.InvoiceNumber));
                FormatTypeCellView(cellsviewInvoiceInquiry["B" + cellIndex.ToString()]);
                cellIndex = cellIndex + 1;
                cellsviewInvoiceInquiry["A" + cellIndex.ToString()].Value = "INVOICE DATE";
                FormatHeaderTypeCellView(cellsviewInvoiceInquiry["A" + cellIndex.ToString()]);
                cellsviewInvoiceInquiry["B" + cellIndex.ToString()].Value = HttpUtility.HtmlEncode(Convert.ToString(this.InvoiceDate));
                FormatTypeCellView(cellsviewInvoiceInquiry["B" + cellIndex.ToString()]);
                cellIndex = cellIndex + 1;
                cellsviewInvoiceInquiry["A" + cellIndex.ToString()].Value = "CFS2 NAME";
                FormatHeaderTypeCellView(cellsviewInvoiceInquiry["A" + cellIndex.ToString()]);
                cellsviewInvoiceInquiry["B" + cellIndex.ToString()].Value = HttpUtility.HtmlEncode(Convert.ToString(this.CFS2Name));
                FormatTypeCellView(cellsviewInvoiceInquiry["B" + cellIndex.ToString()]);
                cellIndex = cellIndex + 1;
                cellsviewInvoiceInquiry["A" + cellIndex.ToString()].Value = "BROKER NAME";
                FormatHeaderTypeCellView(cellsviewInvoiceInquiry["A" + cellIndex.ToString()]);
                cellsviewInvoiceInquiry["B" + cellIndex.ToString()].Value = HttpUtility.HtmlEncode(Convert.ToString(this.BrokerName));
                FormatTypeCellView(cellsviewInvoiceInquiry["B" + cellIndex.ToString()]);
                cellIndex = cellIndex + 1;
                cellsviewInvoiceInquiry["A" + cellIndex.ToString()].Value = "BUSINESS UNIT";
                FormatHeaderTypeCellView(cellsviewInvoiceInquiry["A" + cellIndex.ToString()]);
                cellsviewInvoiceInquiry["B" + cellIndex.ToString()].Value = HttpUtility.HtmlEncode(Convert.ToString(this.BusinessUnit));
                FormatTypeCellView(cellsviewInvoiceInquiry["B" + cellIndex.ToString()]);
                ...
                for (int i = 0; i < Tbl.Columns.Count; i++)
                {
                    ...
                    cellsviewInvoiceInquiry[columname + cellIndex.ToString()].Value = Tbl.Columns[i].ColumnName;
                    FormatHeaderTypeCellView(cellsviewInvoiceInquiry[columname + cellIndex.ToString()]);
                }
                cellIndex = cellIndex + 1;
                //rows
                for (int i = 0; i < Tbl.Rows.Count; i++)
                {
                    ...
                    for (int j = 0; j < Tbl.Columns.Count; j++)
                    {
                        ...
                        columname = getColumnNamefromIndex(columnindexvalue);
                        cellsviewInvoiceInquiry[columname + cellIndex.ToString()].Value = Tbl.Rows[i][j];
                        FormatTypeCellView(cellsviewInvoiceInquiry[columname + cellIndex.ToString()]);
                    }

                    cellIndex = cellIndex + 1;
                }

                worksheetViewInvoiceInquiry.UsedRange.Columns.AutoFit();
                for (int col = 0; col < worksheetViewInvoiceInquiry.UsedRange.ColumnCount; col++)
                {
                    worksheetViewInvoiceInquiry.Cells[1, col].ColumnWidth *= 1.15;
                }
            }
            ...
            try
            {
                using (FileStream fileStream = File.OpenRead(ConfigurationManager.AppSettings["InvoiceInquiry_Excel_Export"] + "\\" + strFileName))
                {
