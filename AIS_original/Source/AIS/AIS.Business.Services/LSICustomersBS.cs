...
namespace ZurichNA.AIS.Business.Logic
{
    public class LSICustomersBS : BusinessServicesBase<LSICustomerBE, LSICustomersDA>
    {
        ...
        {
            return new LSICustomersDA().isLSIRelatedAcctExist(AccountID);
        }
        ...
        {
            LSICustomersDA LSIaccount = new LSICustomersDA();
            return LSIaccount.getDuplLSIPrimaryAccount(isActive, Primselected, AccountID, lsiAcctID);
        }
        /// <summary>
        ...
        {
            LSICustomersDA LSIaccount = new LSICustomersDA();
            return LSIaccount.CheckActiveLSIPrimaryAccount(AccountID);
        }

        public IList<LSICustomerBE> GetActiveLSIPrimaryAccounts(int AccountID, int LSIAccountID)
        {
            LSICustomersDA LSIaccount = new LSICustomersDA();
            return LSIaccount.GetActiveLSIPrimaryAccounts(AccountID, LSIAccountID);
        }
