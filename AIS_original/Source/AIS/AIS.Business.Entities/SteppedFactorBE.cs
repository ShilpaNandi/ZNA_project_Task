...
namespace ZurichNA.AIS.Business.Entities
{
    public class SteppedFactorBE : BusinessEntity<STEPPED_FCTR>
    {
        ...
        string _PolicySymbol;
        public string PolicySymbol
        {
            get
            {

                return _PolicySymbol;
            }
            set
            {
                _PolicySymbol = value;
        ...
        string _PolicyModulus;
        public string PolicyModulus
        {
            get
            {
                return _PolicyModulus;
            }
            set
            {
                _PolicyModulus = value;
            }
        }

        DateTime? _PolicyEffectiveDate;
        public DateTime? PolicyEffectiveDate { get { return _PolicyEffectiveDate; } set { _PolicyEffectiveDate = value; } }

        DateTime _PlanEndDate;
        public DateTime PlanEndDate { get { return _PlanEndDate; } set { _PlanEndDate = value; } }
