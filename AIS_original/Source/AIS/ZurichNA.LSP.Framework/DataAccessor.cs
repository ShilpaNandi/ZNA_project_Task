...
//        public Common common = null;
        ...
        protected virtual void Initialize()
        {
            ...
            {
                //uncomment this line for unit testing  and comment the next line
                //this.Context = this.CreateContext("Data Source=DAVDB1320.amer.zurich.dev;Initial Catalog=AIS_UAT; Persist Security Info=True;MultipleActiveResultSets=true;User ID=AIS_WEB_USER;Password=Cscrac8ng");
