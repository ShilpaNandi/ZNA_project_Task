    ...
    public class SMTPMailer
    {
        ...
        public void SendMail()
        {
            ...
            try
            {
                ...
                mailFrom = ConfigurationManager.AppSettings["ReturnEmailAddress"].ToString();
                FromDisplayName = ConfigurationManager.AppSettings["ReturnDisplayName"].ToString();
                if (FromDisplayName == "")
                ...
                client.Host = ConfigurationManager.AppSettings["SMTPServerName"];
            ...
            catch (System.Net.Mail.SmtpException ex)
            {
                ...
                oCesar.WriteFileLogFile("SMTP Exception while sending E-Mail");
            ...
            catch (Exception e)
            {
                ...
                //throw e;
                CESARInterface oCesar = new CESARInterface();
                oCesar.WriteFileLogFile("Error sending E-Mail");
                oCesar.WriteFileLogFile(e.Message);
            }
        }
