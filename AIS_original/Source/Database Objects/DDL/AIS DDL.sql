...
ALTER TABLE dbo.PREM_ADJ_RETRO
ADD prev_subj_paid_idnmty_amt decimal(15,2) null,
prev_subj_resrv_idnmty_amt decimal(15,2) null
...
As per the Bug  13117	, we altereed the below fileds
		
*********************************************************************************************/

ALTER TABLE dbo.PREM_ADJ_RETRO_DTL
ALTER COLUMN adj_incur_ernd_retro_prem_amt decimal(21,8)

ALTER TABLE dbo.PREM_ADJ_RETRO_DTL
ALTER COLUMN biled_ernd_retro_prem_amt decimal(21,8)