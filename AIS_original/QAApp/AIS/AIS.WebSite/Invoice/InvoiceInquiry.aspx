                    ...
                    <td>
                        <asp:Panel ID="pnlInvInqist" runat="server" CssClass="content" ScrollBars="Auto"
                            ...
                            <asp:AISListView ID="lstInvoiceInquiry" runat="server" OnSelectedIndexChanging="lstInvoiceInquiry_SelectedIndexChanging"
                                ...
                                <LayoutTemplate>
                                    <table id="tblInvinq" class="panelContents" runat="server" width="99%">
                                ...
                                <ItemTemplate>
                                    <tr class="ItemTemplate" runat="server" id="trItemTemplate">
                                        ...
                                        <td>
                                            <asp:LinkButton ID="lnkDraftInternal" runat="server" Text="Internal PDF" Enabled='<%#(Eval("ADJUSTMENT_STATUS")!=null?(Eval("ADJUSTMENT_STATUS").ToString()!=""?(Eval("ADJUSTMENT_STATUS").ToString()!="CALC"?(Eval("ADJUSTMENT_STATUS").ToString()!="CANCELLED"?true:false):false):false):false)%>'
                                                CommandName="GetPDF" CommandArgument='<%# Bind("DRAFT_INTERNAL_KEY") %>'></asp:LinkButton>
                                            <asp:LinkButton ID="lnkDraftExternal" runat="server" Text="External PDF" Enabled='<%#(Eval("ADJUSTMENT_STATUS")!=null?(Eval("ADJUSTMENT_STATUS").ToString()!=""?(Eval("ADJUSTMENT_STATUS").ToString()!="CALC"?(Eval("ADJUSTMENT_STATUS").ToString()!="CANCELLED"?true:false):false):false):false)%>'
                                                CommandName="GetPDF" CommandArgument='<%# Bind("DRAFT_EXTERNAL_KEY") %>'></asp:LinkButton>
                                            <asp:LinkButton ID="lnkDraftCDWorksheet" runat="server" Text="Worksheet PDF" Enabled='<%#(Eval("ADJUSTMENT_STATUS")!=null?(Eval("ADJUSTMENT_STATUS").ToString()!=""?(Eval("ADJUSTMENT_STATUS").ToString()!="CALC"?(Eval("ADJUSTMENT_STATUS").ToString()!="CANCELLED"?true:false):false):false):false)%>'
                                                CommandName="GetPDF" CommandArgument='<%# Bind("DRAFT_CW_KEY") %>'></asp:LinkButton>
                                        </td>
                                        <td>
                                            <asp:LinkButton ID="lnkFinalInternal" runat="server" Text="Internal PDF" Enabled='<%#(Eval("ADJUSTMENT_STATUS")!=null?(Eval("ADJUSTMENT_STATUS").ToString()!=""? (Eval("ADJUSTMENT_STATUS").ToString()=="FINAL INVOICE"?true:(Eval("ADJUSTMENT_STATUS").ToString()=="TRANSMITTED"?true:false)):false):false)%>'
                                                CommandName="GetPDF" CommandArgument='<%# Bind("FNL_INTERNAL_KEY") %>'></asp:LinkButton>
                                            <asp:LinkButton ID="lnkFinalExternal" runat="server" Text="External PDF" Enabled='<%#(Eval("ADJUSTMENT_STATUS")!=null?(Eval("ADJUSTMENT_STATUS").ToString()!=""? (Eval("ADJUSTMENT_STATUS").ToString()=="FINAL INVOICE"?true:(Eval("ADJUSTMENT_STATUS").ToString()=="TRANSMITTED"?true:false)):false):false)%>'
                                                CommandName="GetPDF" CommandArgument='<%# Bind("FNL_EXTERNAL_KEY") %>'></asp:LinkButton>
                                            <asp:LinkButton ID="lnkFinalCDWorksheet" runat="server" Text="Worksheet PDF" Enabled='<%#(Eval("ADJUSTMENT_STATUS")!=null?(Eval("ADJUSTMENT_STATUS").ToString()!=""? (Eval("ADJUSTMENT_STATUS").ToString()=="FINAL INVOICE"?true:(Eval("ADJUSTMENT_STATUS").ToString()=="TRANSMITTED"?true:false)):false):false)%>'
