...
var ext=file.value;
    ...
    else if(ext.substr(len-3,len)!="pdf" && ext.substr(len-3,len)!="xls" && ext.substr(len-3,len)!="doc" )
    {
    ...
    <%--<asp:UpdatePanel runat="server" ID="updInternal">
        <ContentTemplate>--%>
    <asp:Panel ID="pnlAdjMgmtDtls" runat="server" Height="130px" ScrollBars="Auto" Width="910px">
