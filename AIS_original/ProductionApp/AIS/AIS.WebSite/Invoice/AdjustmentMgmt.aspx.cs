...
//        list.Add(btnVoidInv);
    ...
    protected void btnRevisInvoice_Click(object sender, EventArgs e)
    {
        ...
        catch (Exception ee)
        {
            ...
            if(!status)
                ShowError("LSI Interface is not responding. Please contact help desk for resolution.");
            else
                ShowError("Unable to process revision. Please contact help desk for resolution.");
        }
    }
