...
function Tabnavigation(Pagename)
    ...
    <table>
        <tr>
            <td>
                <cc1:TabContainer ID="TabContainer1" runat="server" CssClass="VariableTabs" SkinID="tabVariable" ActiveTabIndex="6">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    ...
                                    <table width="100%" cellpadding="0">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Panel ID="pnlLRF" runat="server" Height="260px" ScrollBars="Auto" Width="910px">
                                                    <asp:AISListView ID="lstLRFPosting" runat="server" OnItemDataBound="ItemDataBoundList"
                                                        ...
                                                        <AlternatingItemTemplate>
                                                            <tr class="AlternatingItemTemplate">
                                                                ...
                                                                <td align="center">
                                                                    <asp:Label ID="lableCurrent" Text='<%# Eval("CURRENT AMOUNT") != null ? (Eval("CURRENT AMOUNT").ToString() != "" ?(decimal.Parse(Eval("CURRENT AMOUNT").ToString())).ToString("#,##0") : "0"): "0"%>' runat="server" ReadOnly="true"></asp:Label>
                                                                </td>
                                                                <td align="center">
                                                                    <asp:Label ID="lableAggtAmt" Text='<%# Eval("AGGR AMT") != null ? (Eval("AGGR AMT").ToString() != "" ?(decimal.Parse(Eval("AGGR AMT").ToString())).ToString("#,##0") : "0"): "0"%>' runat="server" ></asp:Label>
                                                                </td>
                                                                <td align="center">
                                                                    <asp:Label ID="lablePriorYr" Text='<%# Eval("PRIOR YY AMT") != null ? (Eval("PRIOR YY AMT").ToString() != "" ?(decimal.Parse(Eval("PRIOR YY AMT").ToString())).ToString("#,##0") : "0"): "0"%>' runat="server" ReadOnly="true"></asp:Label>
                                                                </td>
                                                                <td align="center">
                                                                   <asp:Label ID="lableAdjPriorYrAmt" Text='<%# Eval("ADJ PRIOR YY AMT") != null ? (Eval("ADJ PRIOR YY AMT").ToString() != "" ?(decimal.Parse(Eval("ADJ PRIOR YY AMT").ToString())).ToString("#,##0") : "0"): "0"%>' runat="server" ></asp:Label>
                                                                   
                                                                </td>
                                                                <td align="center">
                                                                    <asp:Label ID="lablePostingAmt" Text='<%# Eval("POST AMT") != null ? (Eval("POST AMT").ToString() != "" ?(decimal.Parse(Eval("POST AMT").ToString())).ToString("#,##0") : "0"): "0"%>' runat="server" ReadOnly="true"></asp:Label>
                                                                </td>
                                                            </tr>
                                                        </AlternatingItemTemplate>
                                                        <ItemTemplate>
                                                        ...
                                                        <EditItemTemplate>
                                                            <tr class="ItemTemplate">
                                                                ...
                                                                <td align="center">
                                                                    <asp:Label ID="lblCurrent" Text='<%# Eval("CURRENT AMOUNT") != null ? (Eval("CURRENT AMOUNT").ToString() != "" ?(decimal.Parse(Eval("CURRENT AMOUNT").ToString())).ToString("#,##0") : "0"): "0"%>' runat="server" ></asp:Label>
                                                               <%-- <cc1:MaskedEditExtender ID="MaskedEditTotalPaidIndem" runat="server" 
                                                                ...
                                                                <td>
                                                                    <asp:AISAmountTextbox AllowNegetive="true" ID="txtAggtAmt" Text='<%# Eval("AGGR AMT")!= null ? (Eval("AGGR AMT").ToString() != "" ?(decimal.Parse(Eval("AGGR AMT").ToString())).ToString("#,##0") : "0"): "0"%>'  runat="server" MaxLength="11" TabIndex="0"  ></asp:AISAmountTextbox>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:Label ID="lblPriorYr" Text='<%# Eval("PRIOR YY AMT") != null ? (Eval("PRIOR YY AMT").ToString() != "" ?(decimal.Parse(Eval("PRIOR YY AMT").ToString())).ToString("#,##0") : "0"): "0"%>' runat="server" ></asp:Label>
                                                                ...
                                                                <td>
                                                                    <asp:AISAmountTextbox AllowNegetive="true" ID="txtAdjPriorYrAmt" Text='<%# Eval("ADJ PRIOR YY AMT")!= null ? (Eval("ADJ PRIOR YY AMT").ToString() != "" ?(decimal.Parse(Eval("ADJ PRIOR YY AMT").ToString())).ToString("#,##0") : "0"): "0"%>'  runat="server" MaxLength="11" TabIndex="1"  ></asp:AISAmountTextbox>
                                                                    <asp:HiddenField ID="hidAdjPriorYrAmt" Value='<%# Eval("ADJ PRIOR YY AMT")!= null ? (Eval("ADJ PRIOR YY AMT").ToString() != "" ?(decimal.Parse(Eval("ADJ PRIOR YY AMT").ToString())).ToString("#,##0") : "0"): "0"%>'  runat="server" ></asp:HiddenField >
                                                                ...
                                                                <td>
                                                                    <asp:AISAmountTextbox AllowNegetive="true" ID="txtPostingAmt" Text='<%# Eval("POST AMT")!= null ? (Eval("POST AMT").ToString() != "" ?(decimal.Parse(Eval("POST AMT").ToString())).ToString("#,##0") : "0"): "0"%>'  runat="server" Enabled="false" />
