IF EXISTS (SELECT 1 FROM sysobjects 
	WHERE NAME = 'GetAdjReviewILRFPostFund' and TYPE = 'P')
	DROP PROC GetAdjReviewILRFPostFund
GO
/****** Object:  StoredProcedure [dbo].[GetAdjReviewILRFPostFund]    Script Date: 02/03/2009 07:27:54 ******/
SET ANSI_NULLS OFF
GO
...
WHEN POST_TRNS_TYP.TRNS_NM_TXT = 'LBA Adjustment - C&RM' THEN 8
ELSE 9 END "ORDER"
