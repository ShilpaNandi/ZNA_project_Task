                                                ...
                                                <tr class="ItemTemplate">
                                                    ...
                                                    <td align="center">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="reqModulus" Display="Dynamic" runat="server" ControlToValidate="txtModulus"
                                                            ...
                                                            Text="*" />
                                                        <cc1:FilteredTextBoxExtender TargetControlID="txtModulus" FilterType="Numbers" ID="ftePolicyModulus"
                                                            runat="server" />
                                                        <asp:RegularExpressionValidator ID="RegularPolicyMod" runat="server" ControlToValidate="txtModulus"
                                                            Text="*" Display="Dynamic" ValidationGroup="MiscInvoiceSaveGroup" ErrorMessage="Please enter minimum two numeric digits for Policy Module"
                                                            ValidationExpression=".{2}.*" />
                                                ...
                                                <tr class="ItemTemplate">
                                                    ...
                                                    <td>
                                                        ...
                                                        <cc1:FilteredTextBoxExtender TargetControlID="txtModulus" FilterType="Numbers" ID="ftePolicyModulus"
                                                            runat="server" />
                                                        <asp:RegularExpressionValidator ID="RegularPolicyMod" runat="server" ControlToValidate="txtModulus"
                                                            Text="*" Display="Dynamic" ValidationGroup="MiscInvoiceEditGroup" ErrorMessage="Please enter minimum two numeric digits for Policy Module"
                                                            ValidationExpression=".{2}.*" />
                                                    </td>
                                                    <td>
                                                    </td>
