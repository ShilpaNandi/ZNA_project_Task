   ...
   function EnableTxtDedPolLimAmt()
    ...
    <asp:UpdatePanel ID="udpPolicy" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlPolicyInfo" runat="server" Width="910px" Visible="false" Height="120px"
                ScrollBars="Auto">
            ...
            <asp:Panel ID="pnlDetails" runat="server" BorderColor="Black" BorderWidth="1px" Visible="false">
                <table width="100%" id="Table1" runat="server">
                    <tr>
                        ...
                        <td style="vertical-align:middle"><asp:RequiredFieldValidator ID="requiredPolicyModulus" runat="server" ControlToValidate="txtPolicyMod"
                                ErrorMessage="Please Enter Policy Module" Text="*" Display="Dynamic" ValidationGroup="SAVE" />
                            <cc1:FilteredTextBoxExtender TargetControlID="txtPolicyMod" FilterType="Numbers"
                            ...
                            <asp:RegularExpressionValidator ID="RegularPolicyMod" runat="server" ControlToValidate="txtPolicyMod"
                                Text="*" Display="Dynamic" ValidationGroup="SAVE" ErrorMessage="Please Enter minimum two numeric digits for Policy Module"
                                ValidationExpression=".{2}.*" /></td>
                        <td>
                            Policy Effective:
                        </td>
                        <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredEffectiveDate" runat="server" ControlToValidate="txtPolicyEff"
                                ErrorMessage="Please Enter Policy Effective Date" Text="*" Display="Dynamic" ValidationGroup="SAVE" />
                        ...
                        <asp:CompareValidator ID="compareCovType" runat="server" ControlToValidate="ddlCoverageType"
                                ...
                                ValueToCompare="0" ValidationGroup="SAVE" /></td>
                    </tr>
                    <tr>
                        <td>
                            Adjustment Type:
                        ...
                        <td style="vertical-align:middle"><asp:CompareValidator ID="compareAdjustmentType" runat="server" ControlToValidate="ddlAdjustmentType"
                        ...
                        <td>
                            <asp:AISAmountTextbox ID="txtDedPolLimAmt"  runat="server" Width="85px" Font-Size="XX-Small" ValidationGroup="SAVE"></asp:AISAmountTextbox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:ObjectDataSource ID="objALAE" runat="server" SelectMethod="GetLookUpActiveData" TypeName="ZurichNA.AIS.Business.Logic.BLAccess">
                                <SelectParameters>
                        ...
                        <td style="vertical-align:middle"><asp:CompareValidator ID="compareALAE" runat="server" ControlToValidate="ddlALAE"
                        ...
                        <td>
                            <asp:AISAmountTextbox ID="txtALAECAPPED" runat="server" Width="85px"  Font-Size="XX-Small" ValidationGroup="SAVE" 
                             Enabled="false"></asp:AISAmountTextbox>
                        ...
                        <td>
                            <asp:AISAmountTextbox ID="txtOvrDedLimAmt" runat="server" Width="85px" Font-Size="XX-Small"  ValidationGroup="SAVE"> </asp:AISAmountTextbox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:AISAmountTextbox ID="txtNonConv" runat="server" Width="85px" Font-Size="XX-Small" ValidationGroup="SAVE"></asp:AISAmountTextbox>
                        ...
                        <td>
                            <asp:AISAmountTextbox ID="txtOthAmt" runat="server" Width="90px"  Font-Size="XX-Small" ValidationGroup="SAVE" 
                            onkeypress="return AmountValidation(event,this)" ></asp:AISAmountTextbox>
