    ...
    public partial class AdjustProcessingChklst : AISBasePage
    {
        ...
        private Qtly_Cntrl_ChklistBE QltyCntrlListBE
        {
            get
            {
                ...
                return ((RetrieveObjectFromSessionUsingWindowName("qltyCntrlListBE") == null) ?
                  (new Qtly_Cntrl_ChklistBE()) : (Qtly_Cntrl_ChklistBE)RetrieveObjectFromSessionUsingWindowName("qltyCntrlListBE"));
            }
            set
            {
        ...
        private IList<Qtly_Cntrl_ChklistBE> QltyCntrlListBEList
        {
            get
            {
                ...
                if (RetrieveObjectFromSessionUsingWindowName("QltyCntrlListBEList") == null)
                    SaveObjectToSessionUsingWindowName("QltyCntrlListBEList", new List<Qtly_Cntrl_ChklistBE>());
                return (IList<Qtly_Cntrl_ChklistBE>)RetrieveObjectFromSessionUsingWindowName("QltyCntrlListBEList");
            }
            set 
            { 
                //Session["QltyCntrlListBEList"] = value; 
                SaveObjectToSessionUsingWindowName("QltyCntrlListBEList", value); 
            }
        }
        private IList<Qtly_Cntrl_ChklistBE> QltyCntrlListBEListApp
        {
            get
            {
                ...
                if (RetrieveObjectFromSessionUsingWindowName("QltyCntrlListBEListApp") == null)
                    SaveObjectToSessionUsingWindowName("QltyCntrlListBEListApp", new List<Qtly_Cntrl_ChklistBE>());
                return (IList<Qtly_Cntrl_ChklistBE>)RetrieveObjectFromSessionUsingWindowName("QltyCntrlListBEListApp");
            }
            set 
            { 
                //Session["QltyCntrlListBEListApp"] = value; 
                SaveObjectToSessionUsingWindowName("QltyCntrlListBEListApp", value); 
            }
        }
        /// <summary>
        ...
        private Qtly_Cntrl_ChklistBE QltyCntrlApprovedInvListBE
        {
            get
            {
                ...
                return ((RetrieveObjectFromSessionUsingWindowName("qltyCntrlApprovedInvListBE") == null) ?
                   (new Qtly_Cntrl_ChklistBE()) : (Qtly_Cntrl_ChklistBE)RetrieveObjectFromSessionUsingWindowName("qltyCntrlApprovedInvListBE"));
            }
            set
            {
                //Session["qltyCntrlApprovedInvListBE"] = value;
                SaveObjectToSessionUsingWindowName("qltyCntrlApprovedInvListBE", value);
            }
...
//            }
            ...
            else
            {
                ...
                if (lstAdjSetProc.Count > 0)
                {
                    ...
                    for (int row = 0; row < lstAdjSetProc.Count; row++)
                    {
                       ...
                       Label lblIssue_txt = (Label)lstAdjProcChklst.Items[row].FindControl("lblIssue_txt");

                        if (lblIssue_txt.Text.ToLower().Contains("*zurich loss run"))
                        {
                            ...
                            if (lstAdjSetProc[row].CHKLIST_STS_CD != null)
                            {
                                if (drplist.Items.FindByText(lstAdjSetProc[row].CHKLIST_STS_CD.TrimEnd()) != null)

                                    drplist.Text = lstAdjSetProc[row].CHKLIST_STS_CD.TrimEnd();
                            }
                        }
                        else
                        {
            ...
            if (alQltyCntrlLstIDs != null)
            {
                ...
                for (int i = 0; i < lstAdjProcChklst.Items.Count; i++)
                {
                    ...
                    if (QltyCntrlListBE.IsNull())
                    {
                        ...
                        Label lblIssue_txt = (Label)lstAdjProcChklst.Items[i].FindControl("lblIssue_txt");

                        if (lblIssue_txt.Text.ToLower().Contains("*zurich loss run"))
                        {
                            if (drplist.Text.Trim().ToUpper() == "(SELECT)" || drplist.Text == "0")
                            {
                                QltyCntrlListBE.CHKLIST_STS_CD = "";
                            }
                            else
                            {
                    ...
                    else
                    {
                        ...
                        AcctSetupProcChklstBS acctSetupChklstItemService =new AcctSetupProcChklstBS();
                        acctSetupChklstItemService.UpdateQltycntrlchklst(QltyCntrlListBE);
                    }
                }
            }
        }
        ...
        protected void lstAdjProcChklst_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            if (e.Item.ItemType == ListViewItemType.DataItem)
            {
                DropDownList ddlSelectAcctProc = (DropDownList)e.Item.FindControl("ddlSelectAcctProc");
                if (ddlSelectAcctProc != null)
                {
                    Label lblIssue_txt = (Label)e.Item.FindControl("lblIssue_txt");

                    if (lblIssue_txt.Text.ToLower().Contains("*zurich loss run"))
                    {
                        ddlSelectAcctProc.Items.Clear();
                        ddlSelectAcctProc.Items.Insert(0, new ListItem("(Select)", "0"));
                        ddlSelectAcctProc.Items.Insert(1, new ListItem("Risk Intelligence", "Risk Intelligence"));
                        ddlSelectAcctProc.Items.Insert(2, new ListItem("Leader", "Leader"));
                        ddlSelectAcctProc.Items.Insert(3, new ListItem("RM241", "RM241"));
                    }
                }
