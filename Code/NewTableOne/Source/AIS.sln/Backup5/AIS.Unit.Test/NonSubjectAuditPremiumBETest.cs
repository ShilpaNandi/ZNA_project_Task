...
namespace AIS.Unit.Test
{
    ...
    /// <summary>
    ///This is a test class for NonSubjectAuditPremiumBETest and is intended
    ///to contain all NonSubjectAuditPremiumBETest Unit Tests
    ///</summary>
    [TestClass()]
    public class NonSubjectAuditPremiumBETest
    {
        ...
        {
            NonSubjectAuditPremiumBE target = new NonSubjectAuditPremiumBE(); // TODO: Initialize to an appropriate value
        ...
        ///</summary>
        [TestMethod()]
        public void NSATYPETest()
        {
            NonSubjectAuditPremiumBE target = new NonSubjectAuditPremiumBE(); // TODO: Initialize to an appropriate value
            string expected = string.Empty; // TODO: Initialize to an appropriate value
            string actual;
            target.NSATYPE = expected;
            actual = target.NSATYPE;
            Assert.AreEqual(expected, actual);
            
        }

        /// <summary>
        ///A test for Nsa_Typ_ID
        ///</summary>
        [TestMethod()]
        public void Nsa_Typ_IDTest()
        {
            NonSubjectAuditPremiumBE target = new NonSubjectAuditPremiumBE(); // TODO: Initialize to an appropriate value
            int expected = 0; // TODO: Initialize to an appropriate value
            int actual;
            target.Nsa_Typ_ID = expected;
            actual = target.Nsa_Typ_ID;
            Assert.AreEqual(expected, actual);
            
        }

        /// <summary>
        ///A test for Non_Subj_Audt_Prem_Amt
        ///</summary>
        [TestMethod()]
        public void Non_Subj_Audt_Prem_AmtTest()
        {
            NonSubjectAuditPremiumBE target = new NonSubjectAuditPremiumBE(); // TODO: Initialize to an appropriate value
            Nullable<Decimal> expected = new Nullable<Decimal>(); // TODO: Initialize to an appropriate value
            Nullable<Decimal> actual;
            target.Non_Subj_Audt_Prem_Amt = expected;
            actual = target.Non_Subj_Audt_Prem_Amt;
            Assert.AreEqual(expected, actual);
            
        }

        /// <summary>
        ///A test for N_Sub_Prem_Aud_ID
        ///</summary>
        [TestMethod()]
        public void N_Sub_Prem_Aud_IDTest()
        {
            NonSubjectAuditPremiumBE target = new NonSubjectAuditPremiumBE(); // TODO: Initialize to an appropriate value
            int expected = 0; // TODO: Initialize to an appropriate value
            int actual;
            target.N_Sub_Prem_Aud_ID = expected;
            actual = target.N_Sub_Prem_Aud_ID;
            Assert.AreEqual(expected, actual);
        ...
        /// <summary>
        ///A test for NonSubjectAuditPremiumBE Constructor
        ///</summary>
        [TestMethod()]
        public void NonSubjectAuditPremiumBEConstructorTest()
        {
            NonSubjectAuditPremiumBE target = new NonSubjectAuditPremiumBE();
