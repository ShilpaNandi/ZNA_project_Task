...
public partial class AdjCalc_NY_SIF : AISBasePage
{
    ...
    private IList<PremiumAdjNYScndInjuryFundBE> lstPreAdjNYSIF
    {
        get
        {
            ...
            if (RetrieveObjectFromSessionUsingWindowName("lstPreAdjNYSIF") == null)
                SaveObjectToSessionUsingWindowName("lstPreAdjNYSIF", new List<PremiumAdjNYScndInjuryFundBE>());
            return (IList<PremiumAdjNYScndInjuryFundBE>)RetrieveObjectFromSessionUsingWindowName("lstPreAdjNYSIF");
        }
        set 
        {
            //Session["lstPreAdjNYSIF"] = value; 
            SaveObjectToSessionUsingWindowName("lstPreAdjNYSIF", value);
        }
    }
    #endregion
    /// <summary>
