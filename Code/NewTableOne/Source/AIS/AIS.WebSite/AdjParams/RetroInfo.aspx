...
<asp:Content ID="Content3" ContentPlaceHolderID="MainPlaceHolder" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function BasicPremium() {
            ...
            var varTotAgramt = document.getElementsByName(varTotAgr0)[0].innerText.replace(myRegExp, '');
            var valTotAudtamt = document.getElementsByName(varTotAud0)[0].innerText.replace(myRegExp, '');
        ...
        function BasicRow() {
            if ($get(varddlExpoType1).options[$get(varddlExpoType1).selectedIndex].text == "Basic Premium" && (!$get(varchkNA1).checked)) {
                document.getElementsByName(varAudExp1)[0].innerText = addCommas(Maxval);
                document.getElementsByName(varhidAudExp1)[0].value = Maxval;
                if ($get(varddlperType1).options[$get(varddlperType1).selectedIndex].text != "(Select)") {
                    ...
                    document.getElementsByName(varTotAud1)[0].innerText = addCommas(Math.round((parseFloat(Maxval) * parseFloat(var1)) / parseFloat(var2)));
                    document.getElementsByName(varhidTotAud1)[0].value = document.getElementsByName(varTotAud1)[0].innerText;
                }
            }
            if ($get(varddlExpoType2).options[$get(varddlExpoType2).selectedIndex].text == "Basic Premium" && (!$get(varchkNA2).checked)) {
                document.getElementsByName(varAudExp2)[0].innerText = addCommas(Maxval);
                document.getElementsByName(varhidAudExp2)[0].value = Maxval;
                if ($get(varddlperType2).options[$get(varddlperType2).selectedIndex].text != "(Select)") {
                    ...
                    document.getElementsByName(varTotAud2)[0].innerText = addCommas(Math.round((parseFloat(Maxval) * parseFloat(var1)) / parseFloat(var2)));
                    document.getElementsByName(varhidTotAud2)[0].value = document.getElementsByName(varTotAud2)[0].innerText;
                }
            }
            if ($get(varddlExpoType3).options[$get(varddlExpoType3).selectedIndex].text == "Basic Premium" && (!$get(varchkNA3).checked)) {
                document.getElementsByName(varAudExp3)[0].innerText = addCommas(Maxval);
                document.getElementsByName(varhidAudExp3)[0].value = Maxval;
                if ($get(varddlperType3).options[$get(varddlperType3).selectedIndex].text != "(Select)") {
                    ...
                    document.getElementsByName(varTotAud3)[0].innerText = addCommas(Math.round((parseFloat(Maxval) * parseFloat(var1)) / parseFloat(var2)));
                    document.getElementsByName(varhidTotAud3)[0].value = document.getElementsByName(varTotAud3)[0].innerText;
                }
            }
        }
        function ChkNAClick(cmpExpid, chkNa, txt1, txt2, txt3, ddl1, ddl2, chknolim) {
        ...
        function ChkNoLimitClick(cmpExpid, chkNa, chknolim) {
                                        ...
                                        <tr id="Tr1" runat="server" class="ItemTemplate">
                                            ...
                                            <td valign="middle">
                                                <cc1:MaskedEditExtender ID="mskFactorAgr" runat="server" TargetControlID="txtFactorAgr"
                                                    Mask="999999.999999" MaskType="Number" AutoComplete="true" />
