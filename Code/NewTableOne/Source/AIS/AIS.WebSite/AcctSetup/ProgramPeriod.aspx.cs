...
-----          06/29/2010 Zakir Hussain:Two new checkboxes (Include All Surcharges and Use Standard Subject Premium)have been added for the surcharges project.
------         
...
namespace ZurichNA.AIS.WebSite.AcctSetup
{
    public partial class ProgramPeriod : AISBasePage
    {
        ...
        private ProgramPeriodBE progPerBE
        {
            get 
            { 
                //return (ProgramPeriodBE)Session["PROGRAMPERIODBE"]; 
                return (ProgramPeriodBE)RetrieveObjectFromSessionUsingWindowName("PROGRAMPERIODBE");
            }
            set 
            { 
                //Session["PROGRAMPERIODBE"] = value; 
                SaveObjectToSessionUsingWindowName("PROGRAMPERIODBE", value);
            }
        }
        ...
        private IList<PremiumAdjustmentProgramStatusBE> programStatusList
        {
            get 
            { 
                //return (IList<PremiumAdjustmentProgramStatusBE>)Session["PROGRAMSTATUSLIST"]; 
                return (IList<PremiumAdjustmentProgramStatusBE>)RetrieveObjectFromSessionUsingWindowName("PROGRAMSTATUSLIST"); 
            }
            set 
            { 
                //Session["PROGRAMSTATUSLIST"] = value; 
                SaveObjectToSessionUsingWindowName("PROGRAMSTATUSLIST", value);
            }
        }
        ...
        protected void lstProgramPeriod_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            if (e.Item.ItemType == ListViewItemType.DataItem)
            {
                ...
                if (imgProPreEnableDisable != null)
                {
                    ...
                    if (CurrentAISUser.Role != GlobalConstants.ApplicationSecurityGroup.Manager && CurrentAISUser.Role != GlobalConstants.ApplicationSecurityGroup.SystemAdmin)
                    {
                        chkIncldAllSur.Enabled = false;
                        chkStdSubjPrem.Enabled = false;
                    }
                    else 
                    {
                        chkIncldAllSur.Enabled = true;
                        chkStdSubjPrem.Enabled = true;
                    }
                }
        ...
        protected void SAVE_Click(Object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                progPerBE.USE_STD_SUBJ_PREM_IND = chkStdSubjPrem.Checked;
                progPerBE.INCLUDE_ALL_SURCHARGES_IND = chkIncldAllSur.Checked;
        ...
        private bool CopyDependencies(int oldProgPerID, int newProgPerID)
        {
            ...
            /* Removed Audit Info Copy while copying the program period is copied as part of the copy losses wo requirements. 
             * isAuditInfoCopied variable value set to true to avoid the multiple code changes earlier it is isAuditInfoCopied is set to false first and then assigned true if auditinfo insert succeeded.  */
            //-----Audit Information----------------------------
            bool isAuditInfoCopied = true;
        ...
        private bool IsDataChanged(ProgramPeriodBE progPerBE)
        {
            ...
            isDataChanged = (progPerBE.INCLUDE_ALL_SURCHARGES_IND != chkIncldAllSur.Checked) ? true : isDataChanged;

            isDataChanged = (progPerBE.USE_STD_SUBJ_PREM_IND != chkStdSubjPrem.Checked) ? true : isDataChanged;
        ...
        protected void GotoQC(object sender, CommandEventArgs e)
        {
            ...
            ResponseRedirect("~/AcctMgmt/AcctSetupProcChklst.aspx");
        }
        /// <summary>
        ...
        public void ClearFileds()
        {
            ...
            chkStdSubjPrem.Checked = false;
            chkIncldAllSur.Checked = false;
            txtPEOPayIn.Text = "";
            ...
            //E2E Project
            lblGCAPSSource.Text = string.Empty;
            lblGCAPSSource.Visible = false;
...
//                    ddlBKTCYBUYOUT.Items.FindByValue(progPerBE.BNKRPT_BUYOUT_ID.ToString()).Selected = true;
                ...
                chkIncldAllSur.Checked = Convert.ToBoolean(progPerBE.INCLUDE_ALL_SURCHARGES_IND);
                chkStdSubjPrem.Checked = Convert.ToBoolean(progPerBE.USE_STD_SUBJ_PREM_IND);
                ...
                //E2E Project
                if (progPerBE.CREATE_USER_ID == 55555 || progPerBE.UPDATE_USER_ID == 55555)
                {
                    lblGCAPSSource.Visible = true;
                    lblGCAPSSource.Text = "Source: GCAPS";
                }
                else
                {
                    lblGCAPSSource.Visible = true;
                    lblGCAPSSource.Text = "Source: Manual";
                }
