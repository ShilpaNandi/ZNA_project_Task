        ...
        <tr>
            <td>
                ...
                <cc1:TabContainer ID="tcExternalContacts" runat="server" ActiveTabIndex="0" CssClass="CustomTabs"
                    Width="99%" OnActiveTabChanged="LoadData" OnClientActiveTabChanged="ActiveTabChanged" >
                                        ...
                                        <asp:Panel BorderColor="Black" ID="pnlDetails" Visible="False" BorderWidth="1px"
                                            ...
                                            <table width="100%" cellpadding="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtLastName" runat="server" MaxLength="35" Width="246px" ValidationGroup="ExternalSaveGroup"></asp:TextBox><asp:RequiredFieldValidator
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtAddress2" MaxLength="50" runat="server" Width="246px" ValidationGroup="ExternalSaveGroup"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:DropDownList ID="ddlState" runat="server" DataSourceID="objDataSourceState" OnSelectedIndexChanged="ddlState_SelectedIndexChanged"
                                                            DataTextField="LookUpName" DataValueField="LookUpID" Width="253px" AutoPostBack="True">
                                                        </asp:DropDownList>
                                                        <asp:CompareValidator ID="CompareState"  runat="server" ControlToValidate="ddlState"
                                                            Text="*" ErrorMessage="Please Select State/Province" Operator="NotEqual" ValueToCompare="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                       ...
                                                       <asp:CompareValidator ID="compZipCode" runat="server" ControlToValidate="txtZipCode"
                                                        ...
                                                        <cc1:MaskedEditExtender ID="mskZipCode" runat="server" TargetControlID="txtZipCode"
                                                            ...
                                                            CultureTimePlaceholder="" ClearMaskOnLostFocus="False" BehaviorID="_content_mskZipCode" Century="2000" />
                                                        <cc1:MaskedEditValidator ID="MaskedEditValidator2" ControlExtender="mskZipCode" runat="server"
                                                            ControlToValidate="txtZipCode" ErrorMessage="error" InvalidValueBlurredMessage="*"
                                                            InvalidValueMessage="Please Enter valid Zip Code" ValidationExpression="\d{5}-\_{4}|\d{5}-\d{4}|\_{5}-\_{4}"
                                                            ValidationGroup="ExternalSaveGroup"></cc1:MaskedEditValidator>
                                                    </td>
                                                    <td>
                                                        Telephone1:
                                                    </td>
                                                    <td>
                                                        ...
                                                        Mask="(999)999-9999" ClearMaskOnLostFocus="False" BehaviorID="_content_mskTelephone1" Century="2000" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder="" CultureTimePlaceholder="" />
                                                       <cc1:MaskedEditValidator ID="mskValPhone1" ControlExtender="mskTelephone1"
                                                            runat="server" ControlToValidate="txtTelephone1" ErrorMessage="error"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>                                                      
                                                       <asp:TextBox ID="txtTelephone2" runat="server" MaxLength="10" Width="246px" ValidationGroup="ExternalSaveGroup"></asp:TextBox>                                                       
                                                        ...
                                                        Mask="(999)999-9999" ClearMaskOnLostFocus="False" BehaviorID="_content_mskTelephone2" Century="2000" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder="" CultureTimePlaceholder="" />
                                                       <cc1:MaskedEditValidator ID="mskValPhone2" ControlExtender="mskTelephone2"
                                                            runat="server" ControlToValidate="txtTelephone2" ErrorMessage="error"
                                                    ...
                                                    <td>
                                                       <asp:TextBox ID="txtFax" runat="server" MaxLength="10" Width="246px" ValidationGroup="ExternalSaveGroup"></asp:TextBox>
                                                        <cc1:MaskedEditExtender ID="mskFax" runat="server" TargetControlID="txtFax" AutoComplete="False"
                                                            ...
                                                            CultureTimePlaceholder="" BehaviorID="_content_mskFax" Century="2000" />
                                                          <cc1:MaskedEditValidator ID="MaskedEditValidator1" ControlExtender="mskFax" runat="server"
                                                            ControlToValidate="txtFax" ErrorMessage="error" InvalidValueBlurredMessage="*"
