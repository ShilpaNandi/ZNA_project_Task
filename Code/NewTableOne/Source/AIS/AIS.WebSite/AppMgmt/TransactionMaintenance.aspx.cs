/*
 -----	Page:	Transaction Maintainance.

-----	Created:		CSC (Venkata Kolimi)

-----
-----	Description:	This page contains four tabs 1)Lookup Types and Lookup codes.
-----                                                2)Posting Transaction Setup.
-----                                                3)Issue and CheckList Maintenance.
-----                                                4)Bu/Office Maintenance.
-----                    
-----	On Exit:	
-----			
-----
-----   Created Date : 2/17/09 (AS part of Retro Project)
...
-----               05/27/2010  SUneel Mogali
-----           The change is to update the Main/Sub values in Deductible Taxes Setup tab whenever the Main/Sub values are updated in Posting Transaction Setup.
 */
...
public partial class AppMgmt_TransactionMaintenance : AISBasePage
{
    ...
    private LookupBE lookupBE
    {
        ...
        get { return (LookupBE)RetrieveObjectFromSessionUsingWindowName("LOOKUPBE"); }
        set { SaveObjectToSessionUsingWindowName("LOOKUPBE", value); }
    }
    /// <summary>
    ...
    private LookupTypeBE lookuptypeBE
    {
        ...
        get { return (LookupTypeBE)RetrieveObjectFromSessionUsingWindowName("LOOKUPTYPEBE"); }
        set { SaveObjectToSessionUsingWindowName("LOOKUPTYPEBE", value); }
    }
    ...
    private IList<LookupTypeBE> lookuptypeBEList
    {
        get
        {
            ...
            if (RetrieveObjectFromSessionUsingWindowName("lookuptypeBEList") == null)
                SaveObjectToSessionUsingWindowName("lookuptypeBEList", new List<LookupTypeBE>());
            return (IList<LookupTypeBE>)RetrieveObjectFromSessionUsingWindowName("lookuptypeBEList");
        }
        //set { Session["lookuptypeBEList"] = value; }
        set { SaveObjectToSessionUsingWindowName("lookuptypeBEList", value); }
    }
    private IList<PostingTransactionTypeBE> PostingTransactionTypeBEList
    {
        get
        {
            ...
            if (RetrieveObjectFromSessionUsingWindowName("PostingTransactionTypeBEList") == null)
                SaveObjectToSessionUsingWindowName("PostingTransactionTypeBEList", new List<PostingTransactionTypeBE>());
            return (IList<PostingTransactionTypeBE>)RetrieveObjectFromSessionUsingWindowName("PostingTransactionTypeBEList");
        }
        //set { Session["PostingTransactionTypeBEList"] = value; }
        set { SaveObjectToSessionUsingWindowName("PostingTransactionTypeBEList", value); }
    }
    private IList<QCMasterIssueListBE> QCMasterIssueListBEList
    {
        get
        {
            ...
            if (RetrieveObjectFromSessionUsingWindowName("QCMasterIssueListBEList") == null)
                SaveObjectToSessionUsingWindowName("QCMasterIssueListBEList", new List<QCMasterIssueListBE>());
            return (IList<QCMasterIssueListBE>)RetrieveObjectFromSessionUsingWindowName("QCMasterIssueListBEList");
        }
        //set { Session["QCMasterIssueListBEList"] = value; }
        set { SaveObjectToSessionUsingWindowName("QCMasterIssueListBEList", value); }
    }
    private IList<LookupBE> LookupBEList
    {
        get
        {
            ...
            if (RetrieveObjectFromSessionUsingWindowName("LookupBEList") == null)
                SaveObjectToSessionUsingWindowName("LookupBEList", new List<LookupBE>());
            return (IList<LookupBE>)RetrieveObjectFromSessionUsingWindowName("LookupBEList");
        }
        //set { Session["LookupBEList"] = value; }
        set { SaveObjectToSessionUsingWindowName("LookupBEList", value); }
    }
    ...
    private IList<BusinessUnitOfficeBE> BusinessUnitOfficeBEList
    {
        ...
        get
        {
            if (RetrieveObjectFromSessionUsingWindowName("BusinessUnitOfficeBEList") == null)
                SaveObjectToSessionUsingWindowName("BusinessUnitOfficeBEList", new List<BusinessUnitOfficeBE>());
            return (IList<BusinessUnitOfficeBE>)RetrieveObjectFromSessionUsingWindowName("BusinessUnitOfficeBEList");
        }
        set { SaveObjectToSessionUsingWindowName("BusinessUnitOfficeBEList", value); }
    }
    ...
    protected void lstPostTrans_ItemCommand(Object sender, ListViewCommandEventArgs e)
    {
        ...
        if ((e.CommandName.ToUpper() == "UPDATE"))
        {
            ...
            if (!con)
                return;
            //End
            //This code is to update the Main/Sub values in Deductible Taxes Setup tab whenever the Main/Sub values are updated in Posting Transaction Setup.
            DeductibleTaxesBS objDedTaxBS = new DeductibleTaxesBS();
            IList<DeductibleTaxesBE> objDedTaxBE = new List<DeductibleTaxesBE>();
            DeductibleTaxesBE dTaxesBE = new DeductibleTaxesBE();
            bool i;
            lookupBE = LookupService.getLkupRow(Convert.ToInt32(ddlTransTypelist.SelectedValue));
            if ((transBE.MAIN_NBR != txtMain.Text && lookupBE.LookUpName == "DEDUCTIBLE TAX") || 
                                    (transBE.SUB_NBR != txtSub.Text && lookupBE.LookUpName == "DEDUCTIBLE TAX"))
            {
                objDedTaxBE = objDedTaxBS.SelectDataOnTransMainSub(transBE.TRANS_TXT, transBE.MAIN_NBR, transBE.SUB_NBR);
                for(int idTax = 0 ;idTax < objDedTaxBE.Count; idTax++)
                {
                    dTaxesBE = objDedTaxBS.LoadData(objDedTaxBE[idTax].DED_TAXES_SETUP_ID);
                    dTaxesBE.MAIN_NBR_TXT = txtMain.Text;
                    dTaxesBE.SUB_NBR_TXT = txtSub.Text;
                    i = objDedTaxBS.SaveDeductibleTaxes(dTaxesBE);                       
                }
            }
            //Suneel
