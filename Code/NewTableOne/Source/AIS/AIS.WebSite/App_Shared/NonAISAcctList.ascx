<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NonAISAcctList.ascx.cs"
    Inherits="ZurichNA.AIS.WebSite.App_Shared.NonAISAcctList" %>
        ...
        <asp:Panel ID="pnlAccntlist" runat="server">
            <table>
                ...
                <tr>
                    <tr>
                        <td>
                            <asp:DropDownList ID="ddlAccountlist" runat="server" Width="231px" OnSelectedIndexChanged="ddlAccountlist_SelectedIndexChanged"
                                AutoPostBack="true">
                            </asp:DropDownList>
                        </td>
                    </tr>
