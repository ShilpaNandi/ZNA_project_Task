<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LSIAccountList.ascx.cs" Inherits="App_Shared_LSIUserDropdown" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cc1" %>

<asp:UpdatePanel ID="drpLSIUpdatepanel" runat="server" UpdateMode="Conditional">
...
<td>
<asp:DropDownList ID="ddlLSIAccountlist" runat="server" Width="231px">
