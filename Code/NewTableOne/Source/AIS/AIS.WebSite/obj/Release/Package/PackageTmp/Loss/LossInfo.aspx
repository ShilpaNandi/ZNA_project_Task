    ...
    <div style="float: left;">
        <asp:UpdatePanel ID="updPolicyUpload" runat="server">
                            ...
                            <tr>
                                <td align="Center" colspan="3">
                                    ...
                                    <asp:Button ID="btnUploadLoss" runat="server" Text="Upload Loss Info" OnClick="btnUploadLoss_Click"
                                        Enabled="false" />
                                    &nbsp;&nbsp;&nbsp;
                                    <asp:Button ID="btnErrorLogLossInfo" Text="Error Log" OnClick="btnErrorLogLossInfo_Click" Visible="false" runat="server" />
                                </td>
                            </tr>
                            </table>
                            </asp:Panel>
            ...
            <Triggers>
                ...
                <asp:PostBackTrigger ControlID="btnErrorLogLossInfo" />
            </Triggers>
        </asp:UpdatePanel>
    </div>
