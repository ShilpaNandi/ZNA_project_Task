...
namespace ZurichNA.AIS.ARiES.Interface
{
    class ARiESInterface
    {
        ...
        public void WriteARiESData()
        {
            ...
            if (WriteARiESFile() == true)
            {
                ...
                if (UploadARiESFile(sARiESOutputFolder + "\\" + sARiESFileName) == true)
                {
                    ...
                    //Write to log table
                    WriteLog("AIS Contacts ARiES Interface", "Inf", "AIS Contacts ARiES data successfully loaded!", "AIS Contacts ARiES files successfully loaded!", 1);
                }
            }
        }
        ...
        private bool WriteARiESFile()
        {
            ...
            SqlCommand sqlCmd = new SqlCommand("AIS_To_ARIES", conn);
            ...
            try
            {
                ...
                while (rdr.Read())
                {
                    wOut.WriteLine(rdr["MASTERDATAFEED"].ToString());
                }
            ...
            catch (Exception EX)
            {
                ...
                //Write to log table
                WriteLog("AIS Contacts ARiES Interface", "Inf", "AIS Contacts ARiES File Creation Unsuccessfull!", "AIS Contacts ARiES File Creation Unsuccessfull!", 1);
            }
        ...
        private bool UpdateStatus(string companyCode)
        {
            ...
            try
            {
                ...
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.CommandText = "AIS_To_ARIES";
            ...
            catch
            {
                ...
                //Write to log table
                WriteLog("AIS Contacts ARiES Interface", "Inf", "AIS Contacts ARiES Status update unsuccessful!", "AIS Contacts ARiES Status update unsuccessful!", 1);
        ...
        private bool UploadARiESFile(string filename)
        {
            ...
            sscriptFileName = "ARiES_BP_TransmittalScript.TXT";
            ...
            try
            {
                ...
                if (fARiESFileinfo.Exists)
                {
                    ...
                    sbatchFileName = "AIS_BP_TransmittalData" + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() +
                ...
                else
                {
                    ...
                    //Write to log table
                    WriteLog("AIS Contacts ARiES Interface", "Inf", "AIS Contacts ARiES file does not exist - Upload Unsuccessfull!", "AIS Contacts ARiES file does not exist - Upload Unsuccessfull!", 1);
            ...
            catch
            {
                blnUploadARiESFileError = false;
                //Write to log table
                WriteLog("AIS Contacts ARiES Interface", "Inf", "AIS Contacts ARiES FTP File Upload Unsuccessfull!", "AIS Contacts ARiES FTP File Upload Unsuccessfull!", 1);
