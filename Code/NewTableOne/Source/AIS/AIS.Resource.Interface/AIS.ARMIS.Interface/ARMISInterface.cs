    ...
    public class ARMISInterface
    {
        ...
        private bool ProcessARMISData(string sFileType, string sARMIsFile)
        {
            ...
            if (sFileType == "37")
            {
                ...
                while (sDataLine != null)
                {
                    ...
                    sDataLine0 = sDataLine0 + "','" + sDataLine.Substring(56, 6) + "','" + ((sDataLine.Substring(62, 15).Trim().Length == 7) ? "0" + sDataLine.Substring(62, 15).Trim() : ((sDataLine.Substring(62, 15).Trim().Length == 6) ? "00" + sDataLine.Substring(62, 15).Trim(): sDataLine.Substring(62, 15).Trim())) + "','" + sDataLine.Substring(77, 2);
            ...
            if (sFileType == "38")
            {
                ...
                while (sDataLine != null)
                {
                    ...
                    sDataLine0 = sDataLine0 + "','" + ((sDataLine.Substring(105, 15).Trim().Length == 7) ? "0" + sDataLine.Substring(105, 15).Trim() : ((sDataLine.Substring(105, 15).Trim().Length == 6) ? "00" + sDataLine.Substring(105, 15).Trim(): sDataLine.Substring(105, 15).Trim())) + "','" + sDataLine.Substring(120, 10);
        ...
        private void EMailNotification(bool status,string strMessage)
        {
            ...
            if (status == true)
            {
                ...
                //ARMIS_INTRFC37_ERR
                string strArmis37FileName = "ARMIS37_ERROR_" + DateTime.Today.ToString("MM-dd-yyyy") + sSpreadsheetGearExcelFileFormat;
                ...
                FastExportingMethod.ExportToExcelusingSpreadsheetGear(dsArmis37, strArmis37FilePath);

                //ARMIS_INTRFC38_ERR
                string strArmis38FileName = "ARMIS38_ERROR_" + DateTime.Today.ToString("MM-dd-yyyy") + sSpreadsheetGearExcelFileFormat;
                ...
                FastExportingMethod.ExportToExcelusingSpreadsheetGear(dsArmis38, strArmis38FilePath);
