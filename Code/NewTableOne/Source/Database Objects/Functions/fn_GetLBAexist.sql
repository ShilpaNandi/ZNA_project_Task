...
AND PREM_ADJ_PGM_SETUP.CUSTMR_ID = PREM_ADJ_PERD.CUSTMR_ID and PREM_ADJ_PGM_SETUP.actv_ind = 1
INNER JOIN COML_AGMT ON COML_AGMT.CUSTMR_ID = PREM_ADJ_PERD.CUSTMR_ID 
AND COML_AGMT.PREM_ADJ_PGM_ID = PREM_ADJ_PGM.PREM_ADJ_PGM_ID --AND COML_AGMT.ACTV_IND = 1
INNER JOIN PREM_ADJ_PARMET_SETUP ON PREM_ADJ_PARMET_SETUP.CUSTMR_ID = PREM_ADJ_PERD.CUSTMR_ID
...
AND PREM_ADJ_PARMET_DTL.COML_AGMT_ID = COML_AGMT.COML_AGMT_ID
...
--INNER JOIN LKUP LKUP1 ON LKUP1.LKUP_ID = PREM_ADJ_PGM_SETUP.LOS_BASE_ASSES_ADJ_TYP_ID
