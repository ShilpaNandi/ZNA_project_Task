...
{
    private Prem_Adj_Dpst_ChbxBS PremAdjDpstInfo = new Prem_Adj_Dpst_ChbxBS();
    ...
    public Prem_Adj_Dpst_ChbxBS PremAdjDpstChbxBS
    {
        get
        {
    ...
    IList<Prem_Adj_Dpst_ChbxBE> PremAdjDpstChbxCHFBElst
    {
        get
        {            
            if (RetrieveObjectFromSessionUsingWindowName("PremAdjDpstChbxCHFBElst") == null)
                SaveObjectToSessionUsingWindowName("PremAdjDpstChbxCHFBElst", new List<Prem_Adj_Dpst_ChbxBE>());
            return (IList<Prem_Adj_Dpst_ChbxBE>)RetrieveObjectFromSessionUsingWindowName("PremAdjDpstChbxCHFBElst");
        }
        set
        {
            SaveObjectToSessionUsingWindowName("PremAdjDpstChbxCHFBElst", value);
        }
    }
    ...
    protected bool CheckNewCHFUseDpst
    {
        get { return (bool)ViewState["CheckNewCHFUseDpst"]; }
        set { ViewState["CheckNewCHFUseDpst"] = value; }
    }
    protected bool CheckNewCHFUseDpst2
    {
        get { return (bool)ViewState["CheckNewCHFUseDpst2"]; }
        set { ViewState["CheckNewCHFUseDpst2"] = value; }
    }

    //protected bool CheckNewChbxDpstCHF
    //{
    //    get { return (bool)ViewState["CheckNewChbxDpstCHF"]; }
    //    set { ViewState["CheckNewChbxDpstCHF"] = value; }
    //}

    //protected bool CheckNewChbxDpstCHF2
    //{
    //    get { return (bool)ViewState["CheckNewChbxDpstCHF2"]; }
    //    set { ViewState["CheckNewChbxDpstCHF2"] = value; }
    //}
    ...
    protected bool CompareValues(AdjustmentParameterSetupBE AdjCompareLBA, int PolicyCount)
    {
        ...
        if (AdjCompareLBA.AdjparameterTypeID == Lbablaccess.GetLookUpID("LBA", "ADJUSTMENT PARAMETER TYPE"))
        {
            ...
            if (AdjCompareLBA.incld_ibnr_ldf_ind == bool.Parse(LdfIbnrInclCheckBox.Checked.ToString()) &&
                ...
                PremAdjDpstChbx.dpst_ind == bool.Parse(rbtnLBAUseDpst.Checked.ToString())) //For Use Deposit Checkbox row1
            {
        ...
        {
            Prem_Adj_Dpst_ChbxBE PremAdjDpstChbxBE = new Prem_Adj_Dpst_ChbxBE();
            ...
            if (AdjCompareLBA.clm_hndl_fee_basis_id == Convert.ToInt32(ddCHFBasisCharged.SelectedValue) &&
                ...
                PremAdjDpstChbxBE.dpst_ind == bool.Parse(rbtnCHFUseDpst.Checked.ToString())) //For Use Deposit Checkbox row1
            {
    ...
    protected bool CompareValuesecrow(AdjustmentParameterSetupBE AdjCompareLBA, int PolicyCount)
    {
        ...
        if (AdjCompareLBA.AdjparameterTypeID == Lbablaccess.GetLookUpID("LBA", "ADJUSTMENT PARAMETER TYPE"))
        {
            ...
            if (AdjCompareLBA.incld_ibnr_ldf_ind == bool.Parse(LdfIbnrInclCheckBox2.Checked.ToString()) &&
                ...
                PremAdjDpstChbx.dpst_ind == bool.Parse(rbtnLBAUseDpst2.Checked.ToString())) //For Use Deposit Checkbox row2
            {
                IList<AdjustmentParameterPolicyBE> LBAPolBE = AdjParamPolInfo.getAdjParamtrPol(AdjCompareLBA.adj_paramet_setup_id);
                if (LBAPolBE != null)
                {
    ...
    protected Prem_Adj_Dpst_ChbxBE SaveDpstChbxLBA(Prem_Adj_Dpst_ChbxBE PremAdjDpstChbxLBABE, AdjustmentParameterSetupBE AdjStupLBABE)
    {
        Prem_Adj_Dpst_ChbxBS PremAdjDpstChbxbs = new Prem_Adj_Dpst_ChbxBS();
        PremAdjDpstChbxLBABE.prem_adj_pgm_id = int.Parse(ViewState["PRGPRDID"].ToString());
        PremAdjDpstChbxLBABE.prem_adj_pgm_setup_id = AdjStupLBABE.adj_paramet_setup_id;
        PremAdjDpstChbxLBABE.AdjparameterTypeID = Lbablaccess.GetLookUpID("LBA", "ADJUSTMENT PARAMETER TYPE");

        if (rbtnLBAUseDpst.Checked == true)
        {
            PremAdjDpstChbxLBABE.dpst_ind = true;
        }
        else
        {
            PremAdjDpstChbxLBABE.dpst_ind = false;
        }       

        PremAdjDpstChbxLBABE.Cstmr_Id = AISMasterEntities.AccountNumber;

        int prem_adj_dpst_chbx_id = PremAdjDpstChbxbs.getAdjParamResultOther(PremAdjDpstChbxLBABE.prem_adj_pgm_setup_id, PremAdjDpstChbxLBABE.prem_adj_pgm_id, PremAdjDpstChbxLBABE.Cstmr_Id, PremAdjDpstChbxLBABE.AdjparameterTypeID);
        if (prem_adj_dpst_chbx_id > 0)
        {
            PremAdjDpstChbxLBABE.prem_adj_dpst_chbx_id = prem_adj_dpst_chbx_id;
            PremAdjDpstChbxLBABE.UPDATE_DATE = DateTime.Now;
            PremAdjDpstChbxLBABE.UPDATE_USER_ID = CurrentAISUser.PersonID;
        }
        else
        {
            PremAdjDpstChbxLBABE.CREATE_USER_ID = CurrentAISUser.PersonID;
        }

        bool ResultLBA = PremAdjDpstChbxBS.Update(PremAdjDpstChbxLBABE);
        if (ResultLBA)
        {
            bool aptFlag = AdjParameterTransactionWrapper.SubmitTransactionChanges();
            ShowConcurrentConflict(aptFlag, AdjParameterTransactionWrapper.ErrorMessage);
            if (CheckNewincLBA == false)
            {
                ...
                ApplWebPageAudtBS audtBS = new ApplWebPageAudtBS();
                audtBS.AppTransactionWrapper = AdjParameterTransactionWrapper;
                audtBS.Save(AISMasterEntities.AccountNumber, AdjStupLBABE.prem_adj_pgm_id, GlobalConstants.AuditingWebPage.LBASetup, CurrentAISUser.PersonID);
                
            }
        }
        return PremAdjDpstChbxLBABE;
    }
    ...
    protected Prem_Adj_Dpst_ChbxBE SaveDpstChbxLBAForPopup(Prem_Adj_Dpst_ChbxBE PremAdjDpstChbxLBABE, AdjustmentParameterSetupBE AdjStupLBABE)
    {
        ...
        if (ResultLBA)
        {
            ...
            if (CheckNewincLBA == false)
            {
                ...
                ApplWebPageAudtBS audtBS = new ApplWebPageAudtBS();
                audtBS.AppTransactionWrapper = AdjParameterTransactionWrapper;
                audtBS.Save(AISMasterEntities.AccountNumber, PremAdjDpstChbxLBABE.prem_adj_pgm_id, GlobalConstants.AuditingWebPage.LBASetup, CurrentAISUser.PersonID);
    ...
    protected Prem_Adj_Dpst_ChbxBE SaveDpstChbxLBA2(Prem_Adj_Dpst_ChbxBE PremAdjDpstChbxLBABE, AdjustmentParameterSetupBE AdjStupLBABE)
    {
        Prem_Adj_Dpst_ChbxBS PremAdjDpstChbxbs = new Prem_Adj_Dpst_ChbxBS();
        PremAdjDpstChbxLBABE.prem_adj_pgm_id = int.Parse(ViewState["PRGPRDID"].ToString());
        PremAdjDpstChbxLBABE.prem_adj_pgm_setup_id = AdjStupLBABE.adj_paramet_setup_id;
        ...
        if (rbtnLBAUseDpst2.Checked == true)
        {
            PremAdjDpstChbxLBABE.dpst_ind = true;
        }
        else
    ...
    protected Prem_Adj_Dpst_ChbxBE SaveDpstChbxLBAForPopup2(Prem_Adj_Dpst_ChbxBE PremAdjDpstChbxLBABE, AdjustmentParameterSetupBE AdjStupLBABE)
    {
        ...
        try
        {
            ...
            if (PolCount > 0)
            {
                ...
                if (!Flag)
                {
                    ...
                    premAdjDpstChbxBE = SaveDpstChbxLBA(PremAdjDpstChbxBE, adjParmStupBE);
    ...
    protected void btnLBAInfo2DetailsSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (PolCount2 > 0)
            {
                ...
                premAdjDpstChbxBE = SaveDpstChbxLBA2(PremAdjDpstChbxBE, adjParmStupBE);
                BindLBADetails(int.Parse(ViewState["PRGPRDID"].ToString()));
                //                }
                //else
                //{
    ...
    private IList<Prem_Adj_Dpst_ChbxBE> BindlistChbx
    {
        get
        {            
            if (RetrieveObjectFromSessionUsingWindowName("BindlistChbx") == null)
                SaveObjectToSessionUsingWindowName("BindlistChbx", new List<AdjustmentParameterSetupBE>());
            return (IList<Prem_Adj_Dpst_ChbxBE>)RetrieveObjectFromSessionUsingWindowName("BindlistChbx");
        }
        set { SaveObjectToSessionUsingWindowName("BindlistChbx", value); }
    }
    ...
    private void BindLBADetails(int prgprdID)
    {
        try
        {
            ...
            CheckNewCHFUseDpst = true;
            CheckNewCHFUseDpst2 = true;

            LdfIbnrInclCheckBox.Checked = false;
            LdfIbnrInclCheckBox2.Checked = false;

            //For Use Deposit Checkbox row1 & row2
            //rbtnCHFUseDpst.Checked = true;
            //rbtnCHFUseDpst2.Checked = true;
            rbtnLBAUseDpst.Checked = false;
            rbtnLBAUseDpst2.Checked = false;
            ...
            ViewState["ADJCHFDpstChbxID"] = null;
            ViewState["ADJCHFDpstChbxID2"] = null;

            ViewState["PRGPRDID"] = prgprdID;
            int AdjParmSetupID = PremAdjDpstChbxBE.prem_adj_pgm_setup_id;
            ...
            if (PlcyLst.Count > 0)
            {
                ...
                if (WEBPAGEROLE != GlobalConstants.ApplicationSecurityGroup.Inquiry)
                {
                    ...
                    this.rbtnLBAUseDpst.Enabled = true;
                    ...
                    this.rbtnLBAUseDpst2.Enabled = true;
                ...
                BindlistChbx = PremAdjDpstChbxBS.getAdjDpstChbx(AdjParmSetupID, prgprdID, CustomerID);
                //Upade Button CHF
                ...
                if(BindlistChbx != null)
                {
                    foreach(Prem_Adj_Dpst_ChbxBE PremAdjDpstChbxBE in BindlistChbx)
                    {
                        if (PremAdjDpstChbxBE.AdjparameterTypeID == Lbablaccess.GetLookUpID("LBA", "ADJUSTMENT PARAMETER TYPE"))
                        {
                        ...
                        else if (PremAdjDpstChbxBE.AdjparameterTypeID == Lbablaccess.GetLookUpID("CHF", "ADJUSTMENT PARAMETER TYPE"))
                        {

                            if (PremAdjDpstChbxBE.dpst_ind == true)
                            { //Upade Button
                                Prem_Adj_Dpst_ChbxBE premAdjDpstChbxBE = new Prem_Adj_Dpst_ChbxBE();
                                if (premAdjDpstChbxBE.dpst_ind.Value == true)
                                {
                                    rbtnLBAUseDpst.Checked = true;
                                }
                                else
                                {
                                    rbtnLBAUseDpst.Checked = false;
                                ...
                                ViewState["ADJCHFPRGID"] = premAdjDpstChbxBE.prem_adj_pgm_setup_id;
                            ...
                            else
                            {
                                ...
                                ViewState["ADJCHFnonPRGID"] = PremAdjDpstChbxBE.prem_adj_pgm_setup_id;
                    ...
                    foreach (AdjustmentParameterSetupBE LBAParamLBABE in Bindlist)
                    {
                        ...
                        {                          
                            ...
                            { //Upade Button
                                ...
                                {
                                    premAdjDpstChbxBE.dpst_ind = true;
                                }
                                else
                                {
                                    premAdjDpstChbxBE.dpst_ind = false;
                                }
                                lnkBtnCHFadjUpd.Visible = true;
                                lnkBtnCHFadj.Visible = false;
                                imgbtnCHFdisable.Visible = true;
                                ...
                                rbtnCHFinclude.Checked = true;
                                //For Use Deposit Checkbox row1, edited on 30/10/2023
    ...
    //For Use Deposit Checkbox row1
    /// <summary>
    /// Save method used to assign the values to a database field from the screen and save\update the details for checkbox
    /// with Transaction processing for the first row in CHF Tab
    /// </summary>
    /// <param name="PremAdjDpstChbxCHFBE"></param>
    /// <param name="AdjStupCHFBE"></param>
    /// <returns></returns>
    protected Prem_Adj_Dpst_ChbxBE SaveDpstChbxCHF(Prem_Adj_Dpst_ChbxBE PremAdjDpstChbxCHFBE, AdjustmentParameterSetupBE AdjStupCHFBE)
    {
        Prem_Adj_Dpst_ChbxBS PremAdjDpstChbxbs = new Prem_Adj_Dpst_ChbxBS();
        PremAdjDpstChbxCHFBE.prem_adj_pgm_id = int.Parse(ViewState["PRGPRDID"].ToString());
        PremAdjDpstChbxCHFBE.prem_adj_pgm_setup_id = AdjStupCHFBE.adj_paramet_setup_id;
        PremAdjDpstChbxCHFBE.AdjparameterTypeID = Lbablaccess.GetLookUpID("CHF", "ADJUSTMENT PARAMETER TYPE");

        if (rbtnCHFUseDpst.Checked == true)
        {
            PremAdjDpstChbxCHFBE.dpst_ind = true;
        }
        else
        {
            PremAdjDpstChbxCHFBE.dpst_ind = false;
        }
        PremAdjDpstChbxCHFBE.Cstmr_Id = AISMasterEntities.AccountNumber;
        int prem_adj_dpst_chbx_id = PremAdjDpstChbxbs.getAdjParamResultOther(PremAdjDpstChbxCHFBE.prem_adj_pgm_setup_id, PremAdjDpstChbxCHFBE.prem_adj_pgm_id, PremAdjDpstChbxCHFBE.Cstmr_Id, PremAdjDpstChbxCHFBE.AdjparameterTypeID);
        if (prem_adj_dpst_chbx_id > 0)
        {
            PremAdjDpstChbxCHFBE.prem_adj_dpst_chbx_id = prem_adj_dpst_chbx_id;
            PremAdjDpstChbxCHFBE.UPDATE_DATE = DateTime.Now;
            PremAdjDpstChbxCHFBE.UPDATE_USER_ID = CurrentAISUser.PersonID;
        }
        else
        {           
            //PremAdjDpstChbxCHFBE.CREATE_DATE = DateTime.Now;
            PremAdjDpstChbxCHFBE.CREATE_USER_ID = CurrentAISUser.PersonID;
        }

        bool ResultCHF = PremAdjDpstChbxBS.Update(PremAdjDpstChbxCHFBE);
        if (ResultCHF)
        {
            bool aptwFlag = AdjParameterTransactionWrapper.SubmitTransactionChanges();
            ShowConcurrentConflict(aptwFlag, AdjParameterTransactionWrapper.ErrorMessage);
            if (CheckNewincLBA == false)
            {
                ...
                ApplWebPageAudtBS audtBS = new ApplWebPageAudtBS();
                audtBS.AppTransactionWrapper = AdjParameterTransactionWrapper;
                audtBS.Save(AISMasterEntities.AccountNumber, PremAdjDpstChbxCHFBE.prem_adj_pgm_id, GlobalConstants.AuditingWebPage.CHFSetup, CurrentAISUser.PersonID);
            }          
            
        }
        return PremAdjDpstChbxCHFBE;
    }
    ...
    /// <param name="AdjStupCHFBE"></param>
    /// <returns></returns>
    protected Prem_Adj_Dpst_ChbxBE SaveDpstChbxCHF2(Prem_Adj_Dpst_ChbxBE PremAdjDpstChbxCHFBE, AdjustmentParameterSetupBE AdjStupCHFBE)
    {
        Prem_Adj_Dpst_ChbxBS PremAdjDpstChbxbs = new Prem_Adj_Dpst_ChbxBS();
        PremAdjDpstChbxCHFBE.prem_adj_pgm_id = int.Parse(ViewState["PRGPRDID"].ToString());
        PremAdjDpstChbxCHFBE.prem_adj_pgm_setup_id = AdjStupCHFBE.adj_paramet_setup_id;
        ...
        if (rbtnCHFUseDpst2.Checked == true)
        {
            PremAdjDpstChbxCHFBE.dpst_ind = true;
        }
        else
    ...
    protected void btnCHFInfoDetailsSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (PolCountCHF > 0)
            {
                if (CheckNewCHFUseDpst == false)
                {
                    premAdjDpstChbxBE = PremAdjDpstChbxBS.getAdjParamRow(int.Parse(ViewState["ADJCHFDpstChbxID"].ToString()));
                    //adjParmStupBE = AdjPrmStupBS.getAdjParamRow(int.Parse(ViewState["ADJCHFPRGID"].ToString()));
                    //Concurrency Issue
                    Prem_Adj_Dpst_ChbxBE premAdjDpstChbxBEold = (BindlistChbx.Where(o => o.prem_adj_dpst_chbx_id.Equals(int.Parse(ViewState["ADJCHFDpstChbxID"].ToString())))).First();
                    ...
                    bool con = ShowConcurrentConflict(Convert.ToDateTime(premAdjDpstChbxBEold.UPDATE_DATE), Convert.ToDateTime(premAdjDpstChbxBE.UPDATE_DATE));
                    if (!con)
                        return;
                    //End
                    if (CompareValues(premAdjDpstChbxBE, PolCountCHF))
                    {
                        Flag = true;
                    }
                    else
                ...
                if (!Flag)
                {
                    if (CheckNewCHFUseDpst == true)
                    {
                        bool strIncluded = true;

                        AdjustmentParameterSetupBE AdjStupCHFBE = new AdjustmentParameterSetupBE();
                        int prem_adj_pgm_setup_id = AdjStupCHFBE.adj_paramet_setup_id;
                        string AdjReviewResultCHF = PremAdjDpstChbxBS.getAdjParamResult(prem_adj_pgm_setup_id, int.Parse(ViewState["PRGPRDID"].ToString()), AISMasterEntities.AccountNumber, Lbablaccess.GetLookUpID("CHF", "ADJUSTMENT PARAMETER TYPE"), strIncluded);
                        //string AdjReviewResult = AdjPrmStupBS.getAdjParamResult(int.Parse(ViewState["PRGPRDID"].ToString()), AISMasterEntities.AccountNumber, Lbablaccess.GetLookUpID("CHF", "ADJUSTMENT PARAMETER TYPE"), strIncluded);
                        if (AdjReviewResultCHF == "true")
                        {
                            ShowError(GlobalConstants.ErrorMessage.RowNotFoundOrChanged);
                            return;
                        }
                    ...
                    premAdjDpstChbxBE = SaveDpstChbxCHF(PremAdjDpstChbxBE, adjParmStupBE);
                    //Code for logging into Audit Transaction Table 
                    ApplWebPageAudtBS audtBS = new ApplWebPageAudtBS();
                    audtBS.AppTransactionWrapper = AdjParameterTransactionWrapper;
                    ...
                    audtBS.Save(AISMasterEntities.AccountNumber, premAdjDpstChbxBE.prem_adj_pgm_id, GlobalConstants.AuditingWebPage.CHFSetup, CurrentAISUser.PersonID);
                    //AdjParameterTransactionWrapper.SubmitTransactionChanges();
                    BindLBADetails(int.Parse(ViewState["PRGPRDID"].ToString()));
                }
                //else
        ...
        try
        {
            ...
            if (PolCountCHF > 0)
            {
                ...
                if (!Flag)
                {
                    ...
                    premAdjDpstChbxBE = SaveDpstChbxCHF2(PremAdjDpstChbxBE, adjParmStupBE);
                    BindLBADetails(int.Parse(ViewState["PRGPRDID"].ToString()));
                }
                //else
                //{
    ...
    protected void DisableCHFfirstRow(object sender, CommandEventArgs e)
    {
        try
        {
            if (ViewState["ADJCHFDpstChbxID"] != null)
                //if (ViewState["ADJCHFPRGID"] != null)
            {
                //AdjustmentParameterSetupBE AdjStupCHFBE = new AdjustmentParameterSetupBE();
                //int prem_adj_pgm_setup_id = AdjStupCHFBE.adj_paramet_setup_id;
                int AdjPrmsetupID = int.Parse
            ...
            try
            {
                ...
                if (RetrieveObjectFromSessionUsingWindowName("LBAPolDetails") != null)
                {
                    ...
                    if (!Flag)
                    {
                        ...
                        premAdjDpstChbxBE = SaveDpstChbxLBAForPopup(PremAdjDpstChbxBE, adjParmStupBE);
                        BindLBADetails(int.Parse(ViewState["PRGPRDID"].ToString()));
                    }
        ...
        else if (hdnLBARow.Value == "2")
        {
            try
            {
                ...
                if (RetrieveObjectFromSessionUsingWindowName("LBAPolDetails") != null)
                {
                    ...
                    premAdjDpstChbxBE = SaveDpstChbxLBAForPopup2(PremAdjDpstChbxBE, adjParmStupBE);
                    BindLBADetails(int.Parse(ViewState["PRGPRDID"].ToString()));
