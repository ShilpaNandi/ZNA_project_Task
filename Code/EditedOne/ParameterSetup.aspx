<%@ Page Language="C#" MasterPageFile="~/Retro.master" AutoEventWireup="true" Inherits="AdjParams_ParameterSetup"
    Title="Parameter Setup" CodeBehind="ParameterSetup.aspx.cs" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainPlaceHolder" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function ValidateLBACheckBox(oSource, oArgs) {
            ...
            for (var i = 0; i < aControls.length; i++) {
                if (aControls[i].name.substring(46, 61) == 'PolicyNumLstBox') {
                    ...
                    if (aControls[i].checked) { result = true; }
                }
            }
        ...
        function Index_Changed(chk1, chk2) {
            ...
            var lblActInd = $get('<%=hidDisable2row.ClientID%>');

            if (lblActInd.value == "1") {
        ...
        function Index_Changed2(chk1, chk2) {
            ...
            var chkBoxCount2 = chkBoxList2.getElementsByTagName("input");
            var chkBoxCount = chkBoxList.getElementsByTagName("input");
            var lblActInd = $get('<%=hidDisablerow.ClientID%>');
            lblActInd.value = 1;
            if (lblActInd.value == "1") {
        ...
        function CHFIndex_Changed(chk1, chk2) {
            //alert(chk1);
            var control = $get('ctl00_MainPlaceHolder_TabContainer1_tblpnlLBA_lblcheckvalidations');
            if (control != null) {
                control.style.visibility = 'hidden';
            ...
            var chkBoxCount2 = chkBoxList2.getElementsByTagName("input");
            var chkBoxCount = chkBoxList.getElementsByTagName("input");
            var lblActInd = $get('<%=hidDisable2rowCHF.ClientID%>');
        ...
        function CHFIndex_Changed2(chk1, chk2) {
            ...
            var chkBoxCount2 = chkBoxList2.getElementsByTagName("input");
            var chkBoxCount = chkBoxList.getElementsByTagName("input");
            var lblActInd = $get('<%=hidDisablerowCHF.ClientID%>');
            lblActInd.value = 1;
            if (lblActInd.value == "1") {
                for (var i = 0; i < chkBoxCount2.length; i++) {
                    if ((chkBoxCount[i].checked == true)) {
        ...
        function CheckPolicyConflictInERP() {
            var hidIsPolicyUsedInERP = $get('<%=hidIsPolicyUsedInERP.ClientID%>');
            if (hidIsPolicyUsedInERP.value == "1") {

                alert("Duplicate policy with conflicting parameters exist in LBA setup.  Disable existing policy first.");
                return false;
            }
            else {
                return confirm('Are you sure you want to Enable this record?')
            }
        }
        function CheckPolicyConflictNotERP() {
            var hidIsPolicyUsedNotERP = $get('<%=hidIsPolicyUsedNotERP.ClientID%>');
            if (hidIsPolicyUsedNotERP.value == "1") {
    ...
    <script type="text/javascript">
        ...
        function BeginRequestHandler(sender, args) {
            ...
            xPos1 = $get('<%=PnlLcfPolDetails.ClientID%>').scrollLeft;
            yPos1 = $get('<%=PnlLcfPolDetails.ClientID%>').scrollTop;
        }
        ...
        function EndRequestHandler(sender, args) {
            ...
            $get('<%=PnlLcfPolDetails.ClientID%>').scrollLeft = xPos1;
            $get('<%=PnlLcfPolDetails.ClientID%>').scrollTop = yPos1;
        }

        function pageLoad() {
            var popup = $find('<%=modalLBAPolDetails.ClientID%>');
            var popup1 = $find('<%=modalLCFPolDetails.ClientID%>');
            popup.add_shown(EndRequestHandler);
            popup1.add_shown(EndRequestHandler);
            ...
            <td>
                ...
                <cc1:TabContainer ID="TabContainer1" runat="server" CssClass="CustomTabs" ActiveTabIndex="0"
                        ...
                        <ContentTemplate>
                            <div class="grid">
                                <asp:UpdatePanel ID="Updatepanellba" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:HiddenField ID="hdnShowLBA" runat="server" />
                                        <cc1:ModalPopupExtender runat="server" ID="modalLBAPolDetails" TargetControlID="hdnShowLBA"
                                        ...
                                        <div style="float: left;">
                                            ...
                                            <asp:Panel runat="server" CssClass="modalPopup" ID="pnlPolDetails" Style="border: solid 1px black;
                                                overflow-x: hidden; position: static; display: none; width: 650px; padding: 0px;
                                                max-height: 320px; min-height: 20px" HorizontalAlign="Center" ScrollBars="Vertical">
                                                <asp:Panel runat="Server" ID="Panel2" Style="width: 99.50%; cursor: move; padding: 0px;
                                                    background-color: #CCCCCC; height: 20px; border: solid 1px Gray; color: Black;
                                                    text-align: center; vertical-align: middle">
                                                </asp:Panel>
                                                <div style="text-align: center; width: 100%; height: 100%; padding-bottom: 5px; background-color: White;">
                                                    <table align="center">
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lblLBAPopMessage" runat="server"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <asp:DropDownList ID="ddlAdjType" runat="server" Enabled="true" Width="170px" AutoPostBack="true"
                                                                    OnSelectedIndexChanged="ddlAdjType_SelectedIndexChanged">
                                                                    <asp:ListItem>(Select)</asp:ListItem>
                                                                </asp:DropDownList>
                                                                <asp:HiddenField ID="hdnLBARow" runat="server" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td colspan="2" align="center">
                                                                <asp:GridView ID="gvPolicy" runat="server" AutoGenerateColumns="false" OnRowDataBound="gvPolicy_RowDataBound"
                                                                    HeaderStyle-CssClass="LayoutTemplate" Width="100%">
                                                                    <Columns>
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
                                                                            ...
                                                                            <ItemTemplate>
                                                                                <asp:CheckBox ID="chkSelect" runat="server" onclick="Check_Click(this);" AutoPostBack="true"
                                                                                    OnCheckedChanged="chkSelectLBA_CheckedChanged" />
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
                                                ...
                                                <tr class="ItemTemplate" style="vertical-align: middle">
                                                    ...
                                                    <td style="vertical-align: middle">
                                                        <asp:ImageButton ID="imgDisablerow" OnCommand='DisablefirstRow' CommandArgument='<%# Bind("adjt_param_dtl_id") %>'
                                                            runat="server" />
                                                        <asp:HiddenField ID="hidDisablerow" runat="server" />
                                                        <asp:HiddenField ID="hidIsPolicyUsedInERP" runat="server" />
                                                    </td>
                                                    <td style="vertical-align: middle">
                                                        <asp:LinkButton ID="lnkViewDetails" runat="server" Text="Policy Details" Visible="true"
                                                            Width="80px" Enabled="true" OnClick="LBAPolicyDetails_Click" CommandArgument='<%# Bind("adjt_param_dtl_id") %>' />
                                                    </td>
                                                </tr>
                                                <tr class="AlternatingItemTemplate" style="vertical-align: middle">
                                                    ...
                                                    <td style="vertical-align: middle">
                                                        <asp:ImageButton ID="imgDisable2row" OnCommand='DisablesecondRow' CommandArgument='<%# Bind("adjt_param_dtl_id") %>'
                                                            runat="server" />
                                                        <asp:HiddenField ID="hidDisable2row" runat="server" />
                                                        <asp:HiddenField ID="hidIsPolicyUsedNotERP" runat="server" />
                                                    </td>
                                                    <td style="vertical-align: middle">
                                                        <asp:LinkButton ID="LinkButtonView" runat="server" Text="Policy Details" Visible="true"
                                                            Width="80px" Enabled="True" OnClick="LBAPolicyDetails1_Click" CommandArgument='<%# Bind("adjt_param_dtl_id") %>' />
                                                    </td>
                                                </tr>
                                            </table>
                                        </asp:Panel>
                                        ...
                                        <table id="tbdAdjLBAdtls" runat="server" class="panelContents" width="930px">
                                            <tr>
                                                <td>
                                                    ...
                                                    <div class="content" style="height: 144px; width: 880px; overflow: auto">
                                                        <asp:Panel ID="pnlLbaPolicy" runat="server" Height="20px" Width="50px">
                                                            <asp:AISListView ID="lbasetupdetailslistview" runat="server" Visible="false" OnItemEditing="lstLBAParmsetupDtls_ItemEdit"
                                                                ...
                                                                <LayoutTemplate>
                                                                    <table id="tblLayoutLBAdetails" class="ItemTemplate" runat="server" style="width: 820px; height: 30px;" >
                                                                        <tr>
                                                                            <th style="width: 40px; height: 20px;">
                                                                            </th>
                                                                            <th align="center" style="width: 160px; height: 20px;">
                                                                                State
                                                                            </th>
                                                                            <th align="center" style="width: 80px; height: 20px;">
                                                                                Factor
                                                                            </th>
                                                                            <th align="center" style="width: 100px; height: 20px;">
                                                                                Final LBA Amt.
                                                                            </th>
                                                                            <th align="center" style="width: 300px; height: 20px;">
                                                                                Comments
                                                                            </th>
                                                                ...
                                                                <ItemTemplate>
                                                                    <tr class="ItemTemplateForLBASetup">
                                                                        ...
                                                                        <td>
                                                                            <div style="width: 75px; height: 38px; vertical-align: middle;">
                                                                                <asp:Label ID="lblLBAStateID" Width="74px" Text='<%# Bind("PrgParameterStateName") %>'
                                                                                    runat="server"></asp:Label>
                                                                            </div>
                                                                        </td>
                                                                        <td align="left">
                                                                            <div style="width: 12px; height: 38px; vertical-align: middle;">
                                                                        ...
                                                                        <td>
                                                                            <div style="width: 90px; height: 38px; vertical-align: middle;">
                                                                        ...
                                                                        <td>
                                                                            <div style="width: 20px; height: 38px; vertical-align: middle;">
                                                                ...
                                                                <AlternatingItemTemplate>
                                                                    <tr class="AlternatingItemTemplateForLBASetup">
                                                                        <td id="tdDetailsEdit" align="center" runat="server">
                                                                            <asp:LinkButton ID="lbadetailsetupEdit" CommandName="Edit" Text="Edit" runat="server"
                                                                                Visible="true" OnClick="btnlbasetupinfodetails_click" />
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <div style="width: 350px; height: auto; background-color: White; vertical-align: middle;">
                                                                                <asp:TextBox Width="350px" ID="LBASetupComments" Text='<%# Bind("cmmnt_txt")%>' runat="server"
                                                                                    ...
                                                                                    onkeypress="doKeypress(this,500);"
                                                                ...
                                                                <InsertItemTemplate>
                                                                    <tr class="AlternatingItemTemplateForLBASetup">
                                                                        ...
                                                                        <td>
                                                                            <div style="width: 90px; height: 20px; vertical-align: middle;">
                                                                                <asp:AISAmountTextbox ID="txtLBAfinalAmount" Width="89px" Text="" ReadOnly="false"
                                                                                    runat="server"></asp:AISAmountTextbox>
                                                                                <%--<cc1:FilteredTextBoxExtender runat="server" TargetControlID="txtLBAfinalAmount"
                                                                                FilterType="Custom" ValidChars="0123456789," ID="fltrAudexp">
                                                                            </cc1:FilteredTextBoxExtender>--%>
                                                                        ...
                                                                        <td>
                                                                            <div style="width: 350px; height: 20px; background-color: White; vertical-align: middle;">
                                                                                <asp:TextBox Width="350px" ID="LBASetupComments" Text="" runat="server" TextMode="MultiLine"
                                                                                    MaxLength="500" onkeypress="doKeypress(this,500);"
                        ...
                        <ContentTemplate>
                            <div class="grid1">
                                <asp:UpdatePanel ID="UpdatepanelLCF" runat="server" UpdateMode="Conditional" Visible="true">
                                    <ContentTemplate>
                                        <asp:HiddenField ID="hdnShowLCF" runat="server" />
                                        <cc1:ModalPopupExtender runat="server" ID="modalLCFPolDetails" TargetControlID="hdnShowLCF"
                                            PopupControlID="PnlLcfPolDetails" BackgroundCssClass="modalBackground" CancelControlID="btnLcfCancel">
                                        </cc1:ModalPopupExtender>
                                        <div style="float: left;">
                                            <asp:Panel runat="server" CssClass="modalPopup" ID="PnlLcfPolDetails" Style="border: solid 1px black;
                                                overflow-x: hidden; display: none; width: 650px; padding: 0px; max-height: 320px;
                                                min-height: 20px" HorizontalAlign="Center" ScrollBars="Vertical">
                                                <asp:Panel runat="Server" ID="Panel5" Style="width: 99.50%; cursor: move; padding: 0px;
                                                    background-color: #CCCCCC; border: solid 1px Gray; color: Black; text-align: center;
                                                ...
                                                <div style="text-align: center; width: 100%; padding-bottom: 5px; background-color: White;
                                                    ...
                                                    <table align="center">
                                                        <tr>
                                                            <td colspan="2" align="center">
                                                                <asp:Label ID="lblLCFPopMessage" runat="server"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <asp:DropDownList ID="ddlLCFAdjType" runat="server" Enabled="true" Width="170px"
                                                                    AutoPostBack="true" OnSelectedIndexChanged="ddlLCFAdjType_SelectedIndexChanged">
                                                                    <asp:ListItem>(Select)</asp:ListItem>
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td colspan="2" align="center">
                                                                <asp:GridView ID="gvLcfPolList" runat="server" AutoGenerateColumns="false" OnRowDataBound="gvLcfPolList_RowDataBound"
                                                                    HeaderStyle-CssClass="LayoutTemplate" Width="100%">
                                                                    <Columns>
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
                                                        ...
                                                        <tr>
                                                            <td align="right">
                                                                <asp:Button ID="btnLcfUpdate" runat="server" Text="Update" OnClick="btnLcfUpdate_Click" />
                                                            </td>
                                                            <td align="left">
                                                                <asp:Button ID="btnLcfCancel" runat="server" Text="Cancel" OnClick="btnLcfUpdate_Click" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                        ...
                                        <asp:Panel ID="pnlAdjLCF" runat="server" Visible="False" Width="910px">
                                            <table id="tblAdjLCF" visible="true" runat="server" class="panelContents" width="100%">
                                                <tr align="center">
                                                    <th>
                                                    </th>
                                                    <th style="width: 144px; vertical-align: middle">
                                                        Policy #'s
                                                    </th>
                                                    <th>
                                                        LCF Claim Cap
                                                ...
                                                <tr class="ItemTemplate" style="vertical-align: middle">
                                                    ...
                                                    <td>
                                                        <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto" CssClass="content" Height="20px"
                                                            ...
                                                            <asp:CheckBoxList ID="ckkboxlstPolicyno" runat="server" ForeColor="Black" ReadOnly="true"
                                                                BackColor="White" BorderColor="Black" Width="100%">
                                                            </asp:CheckBoxList>
                                                        </asp:Panel>
                                                    </td>
                                                    <td style="vertical-align: middle">
                                                    ...
                                                    <td style="vertical-align: middle">
                                                        <asp:AISAmountTextbox ID="txtLayLCFZurchPay" runat="server" Enabled="True" Width="100px"></asp:AISAmountTextbox>
                                                    ...
                                                    <td style="vertical-align: middle">
                                                        <asp:LinkButton ID="lnkBtnLCFdtls" runat="server" CommandName="Edit" Text="Details"
                                                            Visible="true" Width="53px" OnClick="btnLCFInfoDetailsInfo_Click" />
                                                    </td>
                                                    <td style="vertical-align: middle">
                                                    ...
                                                    <td style="vertical-align: middle">
                                                        <asp:LinkButton ID="lnkLCFPolDetails" runat="server" Text="Policy Details" Visible="true"
                                                            Enabled="false" OnClick="lnkLCFPolDetails_Click" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </asp:Panel>
                                                                    ...
                                                                    <tr style="width: 100%">
                                                                        ...
                                                                        <td align="left">
                                                                            <div style="width: 193px; height: 16px;">
                                                                                <asp:Label ID="lblAdjParmtdtlLCFID" runat="server" Text='<%# Bind("prem_adj_pgm_dtl_id") %>'
                                                                                    Visible="false"></asp:Label>
                                                                                <asp:TextBox ID="txtLCFFactor" Text='<%# Bind("adj_fctr_rt","{0:0.000000}")%>' Width="192px"
                                    ...
                                    <ContentTemplate>
                                        <asp:Panel ID="pnlAdjTM" runat="server" Visible="False">
                                            <table id="tblAdjTM" visible="true" runat="server" class="panelContents">
                                                ...
                                                <tr class="ItemTemplate" style="vertical-align: middle">
                                                    <td style="vertical-align: middle;">
                                                        <asp:LinkButton ID="lnkBtnTMSave" runat="server" Text="Save" Visible="false" OnClick="btnTMInfoDetailsSave_Click"
                                                            Width="42px" />
                                                        <asp:LinkButton ID="lnkBtnTMUpd" runat="server" Text="Update" Visible="false" OnClick="btnTMInfoDetailsSave_Click"
                                                            Width="42px" />
                                                        <asp:LinkButton ID="lnkBtnTMCancel" runat="server" Text="Cancel" Visible="true" OnClick="LBASetupCancel_Click"
                                                            Width="42px" />
                                                    </td>
                                                    <td>
                                                            ...
                                                            <asp:AISListView ID="lstTMSetuplistView" runat="server" Visible="True" OnItemEditing="lstTMParmsetupDtls_ItemEdit"
                                                                        ...
                                                                        <td>
                                                                            <div style="width: 76px; height: 16px;">
                                                                                <asp:Label ID="lblAdjParmtdtlTMID" runat="server" Text='<%# Bind("prem_adj_pgm_dtl_id") %>'
                                                                                    Visible="false"></asp:Label>
                                                                                <asp:Label ID="lblTMpremAssessment" Text='<%# Bind("PremAssementAmt","{0:0.000000}") %>'
                                                                                    runat="server"></asp:Label>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                ...
                                                                <EditItemTemplate>
                                                                    <tr style="width: 100%">
                                                                        ...
                                                                        <td>
                                                                            <div style="width: 76px; height: 16px;">
                                                                                <asp:TextBox ID="txtTMFactor" Text='<%# Bind("adj_fctr_rt","{0:0.000000}")%>' Width="75px"
                                                                                    runat="server"> </asp:TextBox>
                                                                        ...
                                                                        <td>
                                                                            <div style="width: 76px; height: 16px;">
                                                                                <asp:Label ID="lblAdjParmtdtlTMID" runat="server" Text='<%# Bind("prem_adj_pgm_dtl_id") %>'
                                                                                    Visible="false"></asp:Label>
                                                                                <asp:TextBox ID="txtPremAssessmentTM" Text='<%# Bind("PremAssementAmt","{0:0.000000}")%>'
                    ...
                    <cc1:TabPanel runat="server" ID="tblpnlCHF" HeaderText="CHF">
                        ...
                        <ContentTemplate>
                            <asp:Button ID="btnShow" Text="Show" runat="server" Style="display: none" />
                            <cc1:ModalPopupExtender runat="server" ID="modalLSISetup" TargetControlID="btnShow"
                                PopupControlID="Panel4" BackgroundCssClass="modalBackground">
                            </cc1:ModalPopupExtender>
                            <div style="float: left;">
                                <asp:HiddenField ID="HiddenField2" runat="server" />
                                <asp:Panel runat="server" CssClass="modalPopup" ID="Panel4" Style="border: solid 1px black;
                                    overflow-x: hidden; position: static; display: none; width: 800px; padding: 1px;
                                    max-height: 320px; min-height: 20px" HorizontalAlign="Center" ScrollBars="Vertical">
                                    <asp:Panel runat="Server" ID="Panel6" Style="width: 99.50%; cursor: move; padding: 1px;
                                        background-color: #CCCCCC; height: 20px; border: solid 1px black; color: Black;
                                        text-align: center; vertical-align: middle" Font-Size="11px" Font-Bold="true">
                                        LSI CHF Billed
                                    </asp:Panel>
                                    <div style="text-align: center; width: 100%; height: 100%; padding-bottom: 5px; background-color: White;">
                                        <table align="center" style="width: 95%">
                                            <tr>
                                                <td colspan="2" align="center">
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="LayoutTemplate"
                                                        AlternatingRowStyle-CssClass="AlternatingItemTemplate" RowStyle-CssClass="ItemTemplate"
                                                        Width="100%">
                                                        <EmptyDataTemplate>
                                                            No Data Found.
                                                        </EmptyDataTemplate>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <asp:Button ID="btnClosePopCHF" runat="server" Text="Close" OnClick="btnClosePopCHF_Click" />
                                                </td>
                                            </tr>
                                            <%--<tr>
                                                                    <td align="right">
                            ...
                            <div class="gridCHF">
                                            ...
                                            <table id="tblchfadj" visible="true" runat="server" class="panelContents">
                                                ...
                                                <tr class="ItemTemplate" style="vertical-align: middle">
                                                    ...
                                                    <td style="vertical-align: middle" rowspan="2">
                                                        <asp:LinkButton ID="lnkLSISetupERP" runat="server" CommandName="Edit" Text="LSI CHF Billed"
                                                            Visible="true" Enabled="false" Width="81px" OnClick="btnLSISetup_Click" />
                                                        <%--<br />
                                                            <asp:LinkButton ID="lnkLSISetupOutERP" runat="server" CommandName="Edit" Text="Out of ERP"
                                                            Visible="true" Width="81px" OnClick="btnLSISetup2_Click"/>--%>
                                                    </td>
                                                    <td style="vertical-align: middle">
                                                        <asp:HiddenField ID="hidDisablerowCHF" runat="server" />
                                                ...
                                                <tr class="AlternatingItemTemplate" style="vertical-align: middle">
                                                    ...
                                                    <%--<td style="vertical-align: middle">--%>
                                                    <%--<asp:LinkButton ID="lnkLSISetup2ERP" runat="server" CommandName="Edit" Text="Part of ERP"
                                                            Visible="true" Width="81px" OnClick="btnLSISetup_Click"/>
                                                            <br />--%>
                                                    <%-- <asp:LinkButton ID="lnkLSISetup2OutERP" runat="server" CommandName="Edit" Text="LSI CHF Setup"
                                                            Visible="true" Width="81px" OnClick="btnLSISetup2_Click"/>
                                                    </td>--%>
                                                    <td style="vertical-align: middle">
                                                        <asp:HiddenField ID="hidDisable2rowCHF" runat="server" />
                                ...
                                <asp:UpdatePanel ID="UpdatepanelCHFDetails" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <table id="tbdAdjCHFdtls" runat="server" class="panelContents" width="830px">
                                            <tr>
                                                <td>
                                                    ...
                                                    <div class="content" style="height: 124px; width: 100%; overflow: auto">
                                                        <asp:Panel ID="pnlChfLbaPolicy" runat="server" Height="20px">
                                                            <asp:AISListView ID="chfsetupdetailslistview" runat="server" Visible="false" OnItemEditing="lstCHFParmsetupDtls_ItemEdit"
                                                                ...
                                                                OnItemCreated="lstCHFParmsetupDtls_ItemCreated">
                                                                <LayoutTemplate>
                                                                    <table id="tblLayoutCHFdetails" class="ItemTemplate" runat="server" width="100%"
                                                                        style="border: 1px">
                                                                        <tr>
                                                                            <th>
                                                                            </th>
                                                                ...
                                                                <ItemTemplate>
                                                                    <tr class="ItemTemplate">
                                                                        <td id="tdCHFDetailsEdit" align="center" runat="server" style="vertical-align: middle">
                                                                            <asp:LinkButton ID="ChfdetailsetupEdit" CommandName="Edit" Text="Edit" runat="server"
                                                                                Visible="true" OnClick="btnchfsetupinfodetails_click" Enabled="false" />
                                                                        </td>
                                                                        <td style="vertical-align: middle">
                                                                            <asp:Label ID="lblCHFPolicy" runat="server"></asp:Label>
                                                                            <asp:Label ID="lblPolsetupid" Text='<%# Bind("prem_adj_pgm_setup_pol_id") %>' runat="server" Visible="false"></asp:Label>
                                                                        </td>
                                                                        <td style="vertical-align: middle">
                                                                ...
                                                                <AlternatingItemTemplate>
                                                                    <tr class="AlternatingItemTemplate">
                                                                        <td id="tdDetailsEdit" align="center" runat="server" style="vertical-align: middle">
                                                                            <asp:LinkButton ID="ChfdetailsetupEdit" CommandName="Edit" Text="Edit" runat="server"
                                                                                Visible="true" OnClick="btnchfsetupinfodetails_click" Enabled="false" />
                                                                        </td>
                                                                        <td style="vertical-align: middle">
                                                                    ...
                                                                    <tr style="width: 100%">
                                                                        <td>
                                                                            <asp:LinkButton ID="lnkChfprmtSetupUpdate" CommandName="Update" ValidationGroup="SaveCHFDtlsUpdt"
                                                                                Text="Update" runat="server" Visible="true" /><br />
                                                                            <asp:LinkButton ID="lnkCHFCancel" CommandName="Cancel" runat="server" Text="Cancel"
                                                                                Visible="true" />
                                                                        </td>
                                                                        <td align="left" style="padding-left: 5px" >
                                                                            <div style="width: 75px;">
                                                                                <asp:Label ID="hidCHFPolicy" runat="server" Text='<%# Bind("prem_adj_pgm_setup_pol_id") %>'
                                                                                    Visible="false"></asp:Label>
                                                                                <asp:DropDownList ID="ddCHFPolicy" ValidationGroup="SaveCHFDtlsUpdt" runat="server">
                                                                                </asp:DropDownList>
                                                                                <asp:CompareValidator ID="CompddlCHFPolicy" runat="server" ControlToValidate="ddCHFPolicy"
                                                                                    ValidationGroup="SaveCHFDtlsUpdt" ValueToCompare="0" Text="*" Display="Dynamic"
                                                                                    ErrorMessage="Please select a Policy from dropdown box" Operator="NotEqual"></asp:CompareValidator>
                                                                            </div>
                                                                        </td>
                                                                        <td align="left" style="padding-left: 5px">
                                                                            <div style="width: 75px;">
                                                                        ...
                                                                        <td>
                                                                            <div style="width: 90px;">
                                                                                <asp:AISAmountTextbox ID="txtCHFClaimRate" Width="89px" Text='<%# Bind("Clm_hndlfee_clmrate","{0:0}")%>'
                                                                                    runat="server" AllowNegetive="true"> </asp:AISAmountTextbox>
                                                                    ...
                                                                    <tr class="AlternatingItemTemplate">
                                                                        <td>
                                                                            <asp:LinkButton ID="lbCHFsetupdetailSave" CommandName="Save" ValidationGroup="SaveCHFDtls"
                                                                                Text="Save" runat="server" Visible="true" Enabled="false" Height="16px" Width="25px" />
                                                                        </td>
                                                                        <td align="left" style="padding-left: 5px">
                                                                            <div style="width: 75px;">
                                                                                <asp:DropDownList ID="ddCHFPolicy" ValidationGroup="SaveCHFDtls" runat="server">
                                                                                </asp:DropDownList>
                                                                                <asp:CompareValidator ID="CompddlCHFPolicy" runat="server" ControlToValidate="ddCHFPolicy"
                                                                                    ValidationGroup="SaveCHFDtls" ValueToCompare="0" Text="*" Display="Dynamic" ErrorMessage="Please select a Policy from dropdown box"
                                                                                    Operator="NotEqual"></asp:CompareValidator>
                                                                            </div>
                                                                        </td>
                                                                        <td align="left" style="padding-left: 5px">
                                                                        ...
                                                                        <td>
                                                                            <div style="width: 90px;">
                                                                                <asp:AISAmountTextbox ID="txtCHFClaimRate" Text="" Width="89px" ReadOnly="false"
                                                                                    ValidationGroup="SaveCHFDtls" runat="server" AllowNegetive="true">
                                    ...
                                    <ContentTemplate>
                                        <asp:Panel ID="pnlAdjRML" runat="server" Visible="false">
                                            <table id="tblAdjRML" visible="true" runat="server" class="panelContents">
                                                ...
                                                <tr class="ItemTemplate" style="vertical-align: middle">
                                                    <td style="vertical-align: middle;">
                                                        <asp:LinkButton ID="lnkbtnSAVERML" runat="server" Text="Save" Visible="false" Width="42px"
                                                                    ...
                                                                    <tr style="width: 100%">
                                                                        <td>
                                                                            <asp:LinkButton ID="lnkRMLprmtSetupUpdate" CommandName="Update" Text="Update" ValidationGroup="SaveRMLUpdt"
                                                                                runat="server" Visible="true" /><br />
                                                                            <asp:LinkButton ID="lnkRMLCancel" CommandName="Cancel" runat="server" Text="Cancel"
                                                                                Visible="true" />
                                                                        </td>
                                                                        <td>
