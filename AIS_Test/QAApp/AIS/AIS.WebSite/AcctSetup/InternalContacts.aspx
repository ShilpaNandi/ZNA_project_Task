...
var scrollTop1;
    ...
    <asp:UpdatePanel runat="server" ID="updInternal">
        <ContentTemplate>
        <asp:ValidationSummary ID="valSummInternal"  ValidationGroup="Save"
           runat="server" ></asp:ValidationSummary>
           <br />
         <asp:ValidationSummary ID="valSearch" ValidationGroup="Search" 
           runat="server"></asp:ValidationSummary>
            Contact Type:&nbsp;
            ...
            <br />
            <br />
            <asp:Panel ID="Panel1" Width="910px" runat="server" ScrollBars="Auto" Height="150px">
            ...
            <asp:Panel BorderColor="Black" ID="pnlDetails" Visible="false" BorderWidth="1" Width="910px"
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td>
                            <asp:ObjectDataSource ID="objTitle" runat="server" SelectMethod="GetLookUpActiveData" TypeName="ZurichNA.AIS.Business.Logic.BLAccess">
                                <SelectParameters>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:CompareValidator ID="CompareddlState" runat="server" ControlToValidate="ddlState"
                                ValueToCompare="0" ErrorMessage="Please select State" Text="*" Operator="NotEqual"
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <AjaxToolKit:MaskedEditExtender ID="mskZipCode" runat="server" TargetControlID="txtZipCode"
                                Mask="99999-9999" MessageValidatorTip="true" OnFocusCssClass="MaskedEditFocus"
                            ...
                            <asp:RegularExpressionValidator ID="valRegZIP" ControlToValidate="txtZipCode" ValidationGroup="Save"
                                Text="*" ValidationExpression="^(\d{5}\-____|\d{5}\-\d{4})$" ErrorMessage="Please enter Zip code 5 or 9 digits"
                        ...
                        <td>
                            <asp:TextBox ID="txtTelephone" runat="server" Width="246px"></asp:TextBox>
                    ...
                    <tr>
                      ...
                      <tr>
                        ...
                        <td>
                            <asp:ObjectDataSource ID="objadj" runat="server" SelectMethod="GetLookUpActiveData" TypeName="ZurichNA.AIS.Business.Logic.BLAccess">
                                <SelectParameters>
