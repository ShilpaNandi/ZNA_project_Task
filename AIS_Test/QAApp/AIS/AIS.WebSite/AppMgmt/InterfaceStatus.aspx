            ...
            <ItemTemplate>
                <tr class="ItemTemplate" runat="server" id="trItemTemplate">
                    <td runat="server" align="left" id="Td5">
                        <asp:Label ID="Label7" Width="50px" runat="server" Text='<%# Bind("SRC_TXT") %>'></asp:Label>
                    </td>
                    ...
                    <td runat="server" align="left" id="test2">
                        <asp:Label ID="FullDesc" Width="450px" runat="server" Text='<%# Bind("FULL_DESC_TXT") %>'></asp:Label>
                    </td>
