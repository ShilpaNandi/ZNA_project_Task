...
LKUP4.LKUP_TXT+'('+CASE WHEN PGMTYP.LKUP_TXT LIKE 'NON-DEP%' THEN 'Retro' ELSE PGMTYP.LKUP_TXT END +')'  "ADJUSTMENT TYPE",
...
CASE LKUP4.LKUP_TXT WHEN 'INCURRED' THEN 'NOT APPLICABLE' 
ELSE CONVERT(NVARCHAR(30),DATEADD(MONTH, PREM_ADJ_PGM.INCUR_CONV_MMS_CNT, PREM_ADJ_PGM.STRT_DT),101) END "CONV DATE",
...
OUTER APPLY dbo.fn_GetTotOfAuditPrem(PREM_ADJ_PERD.CUSTMR_ID,PREM_ADJ_PGM.PREM_ADJ_PGM_ID) AS AUD
