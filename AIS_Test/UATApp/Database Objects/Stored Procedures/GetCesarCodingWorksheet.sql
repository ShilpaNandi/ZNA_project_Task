...
create table #prevadjid_Revision_New(prev_adj_id int)
			...
			SET @prem_adj_id_cur_Revision_New = CURSOR FAST_FORWARD FOR select distinct [PREM ADJ ID],CustmrID,[PREM ADJ PGM ID] from #tmp2_Revision_New
...
create table #prevadjid_Revision_Old(prev_adj_id int)
			...
			SET @prem_adj_id_cur_Revision_Old = CURSOR FAST_FORWARD FOR select distinct [PREM ADJ ID],CustmrID,[PREM ADJ PGM ID] from #tmp2_Revision_Old
...
(SELECT [INVOICE NUMBER], [INVOICE DATE], [PROGRAM PERIOD], [VALUATION DATE], [INSURED NAME],[BU/OFFICE],[BROKER ID],BROKER, [ADJUSTMENT TYPE],
		[ADJUSTMENT NUMBER],[PREM ADJ ID],[PREM ADJ PGM ID], POLICYID, [POLICY NUMBER],[POLICY PERIOD],[State],[Retro Result],Previous, ISRevised from #tmp_Current_CESAR_Revision_New
UNION 
		SELECT [INVOICE NUMBER], [INVOICE DATE], [PROGRAM PERIOD], [VALUATION DATE], [INSURED NAME],[BU/OFFICE],[BROKER ID],BROKER, [ADJUSTMENT TYPE],
		[ADJUSTMENT NUMBER],[PREM ADJ ID],a.[PREM ADJ PGM ID], a.POLICYID, [POLICY NUMBER],[POLICY PERIOD],[State],[Retro Result],Previous, ISRevised from #tmp_Previous_CESAR_Revision_New a inner join (select policyid,[prem adj pgm id],stateid from #tmp_Previous_CESAR_Revision_New 
...
-----Old Results
(SELECT [INVOICE NUMBER], [INVOICE DATE], [PROGRAM PERIOD], [VALUATION DATE], [INSURED NAME],[BU/OFFICE],[BROKER ID],BROKER, [ADJUSTMENT TYPE],
		[ADJUSTMENT NUMBER],[PREM ADJ ID],[PREM ADJ PGM ID], POLICYID, [POLICY NUMBER],[POLICY PERIOD],[State],[Retro Result],Previous, ISRevised from #tmp_Current_CESAR_Revision_Old
UNION 
		SELECT [INVOICE NUMBER], [INVOICE DATE], [PROGRAM PERIOD], [VALUATION DATE], [INSURED NAME],[BU/OFFICE],[BROKER ID],BROKER, [ADJUSTMENT TYPE],
		[ADJUSTMENT NUMBER],[PREM ADJ ID],a.[PREM ADJ PGM ID], a.POLICYID, [POLICY NUMBER],[POLICY PERIOD],[State],[Retro Result],Previous, ISRevised from #tmp_Previous_CESAR_Revision_Old a inner join (select policyid,[prem adj pgm id],stateid from #tmp_Previous_CESAR_Revision_Old 
...
create table #prevadjid_Void	(prev_adj_id int)
			...
			SET @prem_adj_id_cur_Void = CURSOR FAST_FORWARD FOR select distinct [PREM ADJ ID],CustmrID,[PREM ADJ PGM ID] from #tmp2_Void
...
SELECT [INVOICE NUMBER], [INVOICE DATE], [PROGRAM PERIOD], [VALUATION DATE], [INSURED NAME],[BU/OFFICE],[BROKER ID],BROKER, [ADJUSTMENT TYPE],
		[ADJUSTMENT NUMBER],[PREM ADJ ID],[PREM ADJ PGM ID], POLICYID, [POLICY NUMBER],[POLICY PERIOD],[State],[Retro Result],Previous, ISRevised from #tmp_Current_CESAR_Void
-- StateID, CustmrID,
UNION 
		SELECT [INVOICE NUMBER], [INVOICE DATE], [PROGRAM PERIOD], [VALUATION DATE], [INSURED NAME],[BU/OFFICE],[BROKER ID],BROKER, [ADJUSTMENT TYPE],
		[ADJUSTMENT NUMBER],[PREM ADJ ID],a.[PREM ADJ PGM ID], a.POLICYID, [POLICY NUMBER],[POLICY PERIOD],[State],[Retro Result],Previous, ISRevised from #tmp_Previous_CESAR_Void a inner join (select policyid,[prem adj pgm id],stateid from #tmp_Previous_CESAR_Void 
...
SELECT [INVOICE NUMBER], [INVOICE DATE], [PROGRAM PERIOD], [VALUATION DATE], [INSURED NAME],[BU/OFFICE],[BROKER ID],BROKER, [ADJUSTMENT TYPE],
		[ADJUSTMENT NUMBER],[PREM ADJ ID],[PREM ADJ PGM ID], POLICYID, [POLICY NUMBER],[POLICY PERIOD],[State],[Retro Result],Previous, ISRevised from #tmp_Current_CESAR
-- StateID, CustmrID,
UNION 
		SELECT [INVOICE NUMBER], [INVOICE DATE], [PROGRAM PERIOD], [VALUATION DATE], [INSURED NAME],[BU/OFFICE],[BROKER ID],BROKER, [ADJUSTMENT TYPE],
		[ADJUSTMENT NUMBER],[PREM ADJ ID],a.[PREM ADJ PGM ID], a.POLICYID, [POLICY NUMBER],[POLICY PERIOD],[State],[Retro Result],Previous, ISRevised from #tmp_Previous_CESAR a inner join (select policyid,[prem adj pgm id],stateid from #tmp_Previous_CESAR 
