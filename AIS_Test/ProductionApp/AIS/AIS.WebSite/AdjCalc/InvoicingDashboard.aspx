            ...
            <div style="float: left;">
                <asp:Panel runat="server" CssClass="modalPopup" ID="Panel1" Style="border: solid 1px black;
                    ...
                    <div style="text-align: center; width: 100%; padding-bottom: 5px; background-color: White;">
                        <br />
                       A key field has been changed to one or more of the program periods. Please proceed to the Adjustment Review Menu_BU Broker Tab OR Cancel the adjustment and Re-set the Broker and/or BU/Office to the prior values and calculate. 
