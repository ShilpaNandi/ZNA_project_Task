...
namespace ZurichNA.AIS.Business.Logic
{
    public class PremAdjustmentBS : BusinessServicesBase<PremiumAdjustmentBE, PremAdjustmentDA>
    {
        ...
        ///-----------------------------------------------------------------------------------///
        /// <summary>
        /// Business service Mehod used to retrieve the Adjustment Info for the Bu Broker Review Screen
        /// </summary>
        ...
        public IList<PremiumAdjustmentBE> getBuBrokerReviewAdjustmentInfo(int intPremAdjID)
        {
            ...
            try
            {
                list = objPremAdjDA.getBuBrokerReviewAdjustmentInfo(intPremAdjID);
            }
        ...
        {           
            try
            {
                return new PremAdjustmentDA().GetRecentValDate(accountID);
        ...
        //Get recent prem adj id
        public PremiumAdjustmentBE GetRecentAdjID(int accountID)
        {            
            try
            {
                return new PremAdjustmentDA().GetRecentAdjID(accountID);
