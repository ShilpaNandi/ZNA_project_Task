/*-----	Page:	Posting Transaction Type Business Service Layer
-----
-----	Created:		CSC (Venkat Kolimi)

-----
-----	Description:	The business logic for Posting Transaction Type is present here and it interacts with the data accessor layer to retrieve data from the database.
-----
-----	On Exit:	
-----			
-----
...
-----  07/05/2010 Venkat/Zakir--New Methid IsMainSubExists has been added. 
*/
...
namespace ZurichNA.AIS.Business.Logic
{
    public class PostingTransactionTypeBS : BusinessServicesBase<PostingTransactionTypeBE, PostingTransactionTypeDA>
    {
        ...
        public bool IsMainSubExits(string strTransactionText, string strTransactionTypeText)
        {
            ...
            try
            {
                Results = postTrans.IsMainSubExits(strTransactionText, strTransactionTypeText);
            }
            catch (Exception ex)
            {
                RetroDatabaseException myException = new RetroDatabaseException(ex.Message, ex);
