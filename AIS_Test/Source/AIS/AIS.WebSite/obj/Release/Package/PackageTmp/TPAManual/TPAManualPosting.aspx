        ...
        <ContentTemplate>
                ...
                <asp:AISListView ID="lstTPADtl" runat="server" InsertItemPosition="FirstItem" DataKeyNames="ThirdPartyAdminManualInvoiceDtlID"
                    ...
                    <ItemTemplate>
                        <tr class="ItemTemplate" id="trItemTemplate" runat="server">
                            ...
                            <td align="left">
                                <asp:Label ID="lblAmount" runat="server" Text='<%# (Eval("ThirdPartyAdminAmt") != null && (Eval("ThirdPartyAdminAmt").ToString() != "")) ?(decimal.Parse(Eval("ThirdPartyAdminAmt").ToString())).ToString("#,##0.00") : ""%>'></asp:Label>
                            </td>
                        </tr>
                    </ItemTemplate>
                        ...
                        <tr class="ItemTemplate">
                            ...
                            <td align="left" nowrap>
                                ...
                                <asp:RequiredFieldValidator ID="requiredPolicyModulus" runat="server" ControlToValidate="txtpolmodules"
                                    ...
                                    ValidationGroup="updateDetails" />
                                <AjaxToolKit:FilteredTextBoxExtender TargetControlID="txtpolmodules" FilterType="Numbers,LowercaseLetters,UppercaseLetters"
                                ...
                                <asp:RegularExpressionValidator ID="RegularPolicyMod" runat="server" ControlToValidate="txtpolmodules"
                                    Text="*" Display="Dynamic" ValidationGroup="updateDetails" ErrorMessage="Please enter minimum two alphanumeric characters for Policy Module"
                                    ValidationExpression=".{2}.*" />
                            </td>
                            <td align="left" nowrap>
                        ...
                        <tr class="ItemTemplate" align="left">
                            ...
                            <td align="left" nowrap>
                                ...
                                <AjaxToolKit:FilteredTextBoxExtender TargetControlID="txtpolmodules" FilterType="Numbers,LowercaseLetters,UppercaseLetters"
                                    ID="ftePolicyModulus" runat="server" />
                                <asp:RegularExpressionValidator ID="RegularPolicyMod" runat="server" ControlToValidate="txtpolmodules"
                                    Text="*" Display="Dynamic" ValidationGroup="saveDetails" ErrorMessage="Please enter minimum two alphanumeric characters for Policy Module"
                                    ValidationExpression=".{2}.*" />
                            </td>
                            <td align="left" nowrap>
            ...
            <div style="text-align: right">
                ...
                <asp:Button ID="btnFinalize" ValidationGroup="Save" runat="server" Text="Finalize"
                    ...
                    <asp:Button ID="btnTPAMgmt" ToolTip="Please click here to see TPA Posting Management"
                            runat="server" Text="TPA Mgmt" OnClick="btnTPAMgmt_Click" />
            </div>
