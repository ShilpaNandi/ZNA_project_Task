                                        ...
                                        <asp:Panel ID="pnlAdlLBA" runat="server" Visible="False">
                                            <table id="tbllbaadj" runat="server" class="panelContents">
                                                ...
                                                <tr class="ItemTemplate" style="vertical-align: middle">
                                                    ...
                                                    <td style="vertical-align: middle">
                                                        <asp:CheckBox ID="chkbxLBAUseDpst" runat="server" Checked="false" Enabled="true" ></asp:CheckBox>
                                                    </td>
                                                </tr>
                                                <tr class="AlternatingItemTemplate" style="vertical-align: middle">
                                                    ...
                                                    <td style="vertical-align: middle">
                                                        <asp:CheckBox ID="chkbxLBAUseDpst2" runat="server" Checked="false" Enabled="true" ></asp:CheckBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </asp:Panel>
                                        ...
                                        <asp:Panel ID="pnlADlCHF" runat="server" Visible="false">
                                            <table id="tblchfadj" visible="true" runat="server" class="panelContents">
                                                ...
                                                <tr class="ItemTemplate" style="vertical-align: middle">
                                                    ...
                                                    <td style="vertical-align: middle">
                                                        <asp:CheckBox ID="chkbxCHFUseDpst" runat="server" Checked="false" Enabled="true" ></asp:CheckBox>
                                                    </td>
                                                </tr>
                                                <tr class="AlternatingItemTemplate" style="vertical-align: middle">
                                                    <td style="vertical-align: middle">
                                                    ...
                                                    <td style="vertical-align: middle">
                                                        <asp:CheckBox ID="chkbxCHFUseDpst2" runat="server" Checked="false" Enabled="true" ></asp:CheckBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </asp:Panel>
