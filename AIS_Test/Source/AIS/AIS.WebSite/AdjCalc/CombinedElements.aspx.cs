...
public partial class AdjCalc_CombinedElements : AISBasePage
{
    ...
    private IList<PremiumAdjCombElementsBE> lstPreAdjCE
    {
        get
        {
            ...
            if (RetrieveObjectFromSessionUsingWindowName("lstPreAdjCE") == null)
                SaveObjectToSessionUsingWindowName("lstPreAdjCE", new List<PremiumAdjCombElementsBE>());
            return (IList<PremiumAdjCombElementsBE>)RetrieveObjectFromSessionUsingWindowName("lstPreAdjCE");
        }
        set 
        { 
            //Session["lstPreAdjCE"] = value; 
            SaveObjectToSessionUsingWindowName("lstPreAdjCE", value);
        }
    }
    #endregion
    /// <summary>
