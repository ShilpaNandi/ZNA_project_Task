...
public partial class ExcessNonBillable : AISBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblStateText.Text = Server.HtmlDecode(Server.HtmlEncode(AISMasterEntities.ExcessLoss.State));
        //lblStartDateText.Text = AISMasterEntities.ExcessLoss.ProgramPeriod;
        //lblStartDateText.Text = Server.HtmlDecode(Server.HtmlEncode(AISMasterEntities.ExcessLoss.ProgramPeriod));
        //lblStartDateText.Text = string.IsNullOrEmpty(AISMasterEntities.ExcessLoss.ProgramPeriod.Trim()) ? "" : HttpUtility.HtmlDecode(HttpUtility.HtmlEncode(AISMasterEntities.ExcessLoss.ProgramPeriod)); // EAISA - 7  fix for veracode 06142018
        lblStartDateText.Text = HttpUtility.HtmlEncode(Convert.ToString(AISMasterEntities.ExcessLoss.ProgramPeriod));
    ...
    private void ShowNonBillableLoss(int intARMISLOSSEXCID)
    {
        ...
        ResponseRedirect("LossesReport.aspx?mode=NonBillable");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (CheckNew == true)
        {
            ...
            SaveObjectToSessionUsingWindowName("ArmisExcID", ExcNonBilBE.ARMIS_LOS_EXC_ID.ToString());
            SaveObjectToSessionUsingWindowName("SysGen", "false");
            BindListView();
            CheckNew = false;
            //ClearFileds();
        ...
        else
        {
            ...
            String strvalue = RetrieveObjectFromSessionUsingWindowName("ArmisExcID").ToString();
            ...
            if (RetrieveObjectFromSessionUsingWindowName("SysGen").ToString() == "True")
            {
    ...
    protected void lsvExcessNonBillable__SelectedIndexChanging(object sender, ListViewSelectEventArgs e)
    {
        ...
        SaveObjectToSessionUsingWindowName("ArmisExcID", intArmisExcID);
        ...
        SaveObjectToSessionUsingWindowName("ClaimStatus", hidsts.Value);
    ...
    public void DisplayDetails(int intArmisExcID)
    {
        ...
        string strvalue = RetrieveObjectFromSessionUsingWindowName("ClaimStatus").ToString();
        ...
        SaveObjectToSessionUsingWindowName("SysGen", sysGen.ToString());
        if (sysGen)
        {
    ...
    private ExcessNonBillableBE ExcNonBilBE
    {
        ...
        get { return (ExcessNonBillableBE)RetrieveObjectFromSessionUsingWindowName("ExcNonBilBE"); }
        set { SaveObjectToSessionUsingWindowName("ExcNonBilBE", value); }
    }
    private IList<ExcessNonBillableBE> ExcNonBilBEList
    {
        get
        {
            ...
            if (RetrieveObjectFromSessionUsingWindowName("ExcNonBilBEList") == null)
                SaveObjectToSessionUsingWindowName("ExcNonBilBEList", new List<ExcessNonBillableBE>());
            return (IList<ExcessNonBillableBE>)RetrieveObjectFromSessionUsingWindowName("ExcNonBilBEList");
        }
        //set { Session["ExcNonBilBEList"] = value; }
        set { SaveObjectToSessionUsingWindowName("ExcNonBilBEList", value); }
    }
