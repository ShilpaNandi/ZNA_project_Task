                        ...
                        <ContentTemplate>
                            <div class="gridESCROW">
                                <asp:UpdatePanel ID="UpdatepanelESCROW" runat="server" UpdateMode="Conditional" Visible="true">
                                    <ContentTemplate>
                                        <asp:Panel ID="pnlESCROWDtls" runat="server" Visible="false" Width="744px">
                                ...
                                ValidChars="0123456789," ID="fltAmount">
                                                    ...
                                                    <td style="vertical-align: middle">
                                                        <asp:CheckBox ID="chkbxUseLossFund" runat="server" Checked="false" Enabled="true" ></asp:CheckBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </asp:Panel>
