IF EXISTS (select 1 from sysobjects where name = 'ModAISDeleteReCalcData' and type = 'P')
...
@UnChecked_recalc_prem_adj_perds varchar(4000),
@debug bit = 0
as
		...
		******************************************************************/
		...
		while @@Fetch_Status = 0
			begin
				...
				--Start:Texas Tax tables data deletion
				...
				--End:Texas Tax tables data deletion
...
--
				...
				***************************************************/
				...
				delete from dbo.PREM_ADJ_SURCHRG_DTL_AMT WITH (ROWLOCK)  
				where --custmr_id = @customer_id  
				--and prem_adj_id = @premium_adjustment_id  
				--and   
				prem_adj_perd_id = @prem_adj_perd_id_Delete 
