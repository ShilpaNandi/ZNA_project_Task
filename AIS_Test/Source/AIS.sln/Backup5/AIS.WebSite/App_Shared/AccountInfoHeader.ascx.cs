...
public partial class App_Shared_MasterUser : System.Web.UI.UserControl
{
    ...
    {        //06/23 for veracode
           ...
           // this.lbl2genericrow1.Text = Convert.ToString(me.AccountNumber);
            ...
            this.lbl1genericrow2.Text = string.IsNullOrEmpty(me.SSCGID.Trim()) ? "" : System.Web.HttpUtility.HtmlDecode(System.Web.HttpUtility.HtmlEncode(me.SSCGID)); // EAISA - 7  06142018 for veracode

            //06/23 for veracode
            //this.lbl2genericrow2.Text = me.Bpnumber;
            //this.lbl2genericrow2.Text = Server.HtmlDecode(Server.HtmlEncode(me.Bpnumber));
            this.lbl2genericrow2.Text = string.IsNullOrEmpty(me.Bpnumber.Trim()) ? "" : System.Web.HttpUtility.HtmlDecode(System.Web.HttpUtility.HtmlEncode(me.Bpnumber)); // EAISA - 7  06142018 for veracode
