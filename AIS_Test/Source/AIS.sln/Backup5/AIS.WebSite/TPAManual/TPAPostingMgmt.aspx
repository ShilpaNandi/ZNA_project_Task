    ...
    <asp:UpdatePanel runat="server" ID="upAccountDashboard">
        <ContentTemplate>
            ...
            <table>
                ...
                <tr>
                    <td>
                        <asp:Panel ID="panTpaInfo" runat="server" Height="250px" Width="930px" ScrollBars="Auto"
                            Visible="true">
                            <asp:AISListView ID="lstTpa" runat="server" OnSorting="lstTpa_Sorting" OnItemCommand="CommandList"
                                ...
                                <ItemTemplate>
                                    <tr id="Tr1" runat="server" class="ItemTemplate">
                                        ...
                                        <td>
                                            <asp:Label ID="lblValnDate" Width="55px" runat="server" Text='<%# Eval("ValuationDate", "{0:d}")%>'></asp:Label>
                                        </td>
                                        <%--  <td>
                                        ...
                                        <td align="left">
                                            <asp:Label ID="lblBuOffice" Width="55px" runat="server" Text='<%# Bind("BU_OFFICE_TEXT")%>'></asp:Label>
                                        </td>
                                        <td align="left">
                                            <asp:Label ID="lblInvDate" Width="55px" runat="server" Text='<%# Eval("InvoiceDate", "{0:d}")%>'></asp:Label>
                                        </td>
                                        <td align="left">
                                        ...
                                        <td align="left">
                                            <asp:LinkButton ValidationGroup="search" ID="lbnDetails" Width="25px" runat="server"
            ...
            <asp:Button ID="btnVoid"  Style="display:none" runat="server"></asp:Button>
            <asp:Button ID="btnRevise" Style="display:none" runat="server"></asp:Button>
