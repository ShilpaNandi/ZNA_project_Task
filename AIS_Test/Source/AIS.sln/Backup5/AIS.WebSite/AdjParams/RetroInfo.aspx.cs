...
public partial class AdjParameters_RetroInfo : AISBasePage
{
    protected AISBusinessTransaction RetroInfoTransWrapper
    {
        get
        {
            ...
            if ((AISBusinessTransaction)RetrieveObjectFromSessionUsingWindowName("RetroTransaction") == null)
                SaveObjectToSessionUsingWindowName("RetroTransaction", new AISBusinessTransaction());
            return (AISBusinessTransaction)RetrieveObjectFromSessionUsingWindowName("RetroTransaction");
        }
        set
        {
            //Session["RetroTransaction"] = value;
            SaveObjectToSessionUsingWindowName("RetroTransaction", value);
        }
    }
    ...
    private IList<RetroInfoBE> RetroListOld
    {
        ...
        get { return (IList<RetroInfoBE>)RetrieveObjectFromSessionUsingWindowName("RetroListOld"); }
        set { SaveObjectToSessionUsingWindowName("RetroListOld", value); }
    }
    ...
    protected void LstRetroInfo_DataBoundList(Object sender, ListViewItemEventArgs e)
    {
        ...
        if (e.Item.ItemType == ListViewItemType.DataItem)
        {
            ...
            chk.Attributes["onclick"] = "javascript:ChkNAClick('" + cmpExpo.ClientID + "','" + chk.ClientID + "','" + txtExposureAgr.ClientID + "','" + txtFactor.ClientID + "','" + txtFactorAgr.ClientID + "','" + ddlPerType.ClientID + "','" + ddlExposureType.ClientID + "','" + chkNoLimit.ClientID + "')";
            chkNoLimit.Attributes["onclick"] = "javascript:ChkNoLimitClick('" + cmpExpo.ClientID + "','" + chkNoLimit.ClientID + "','" + chk.ClientID + "')";
            if (chk.Checked)
            {
